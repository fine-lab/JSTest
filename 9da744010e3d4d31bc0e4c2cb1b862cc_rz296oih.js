...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    sql += " ,snDetail.dc_data dcDate,snDetail.date_Of_Production outDate,snDetail.maturity_Date dueDate,snDetail.volume volume, snDetail.rough_Weight gross_weight ";
    ...
    for (var i = 0; i < res.length; i++) {
      ...
      if (JSON.stringify(header) == "{}") {
        ...
        //组织
        header.officeName = "贵州数算互联科技有限公司";
      ...
      snData.remark = "";
      //数算中外运新增字段 start
      snData.dcDate = resData.dcDate;
      snData.outDate = resData.outDate;
      snData.dueDate = resData.dueDate;
      snData.volume = resData.volume;
      snData.gross_weight = resData.gross_weight;
      //数算中外运新增字段 end
