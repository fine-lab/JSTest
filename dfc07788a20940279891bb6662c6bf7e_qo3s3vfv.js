...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker10uh() {},
  formulacustomSetValueDateTimePicker12uh() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker10uh: observable,
  formulacustomSetValueDateTimePicker12uh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker10uh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker10u", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker10uh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker12uh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker12u", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker12uh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
