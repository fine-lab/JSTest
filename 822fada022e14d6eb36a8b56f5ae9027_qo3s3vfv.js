...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20og() {},
  formulacustomSetValueDateTimePicker9ki() {},
  formulacustomSetValueDateTimePicker11ci() {},
  formulacustomSetValueInputNumber0jf() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20og: observable,
  formulacustomSetValueDateTimePicker9ki: observable,
  formulacustomSetValueDateTimePicker11ci: observable,
  formulacustomSetValueInputNumber0jf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20og: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0we")],
      async ([formStore_UserReferInput0we]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0we.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0we.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20o", resultData);
          },
          "formula_customSetValue_formStore_Input20og" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9ki: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker9k", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9ki" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker11ci: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker11c", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker11ci" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber0jf: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9k")],
      async ([formStore_DateTimePicker9k]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber0j",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker9e,DateTimePicker9k,3)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9e,DateTimePicker9k"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber0j",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber0j", resultData);
          },
          "formula_customSetValue_formStore_InputNumber0jf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
