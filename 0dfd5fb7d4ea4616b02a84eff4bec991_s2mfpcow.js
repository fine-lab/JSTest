...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibledibulan1() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibledibulan1: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_dibulan1: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibledibulan1 = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibledibulan1 = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_dibulan1" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
