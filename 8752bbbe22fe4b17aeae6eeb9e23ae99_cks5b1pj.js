...
class MyTrigger extends AbstractTrigger {
  execute(context) {
    try {
      ...
      let resObject = funcTotalProfit.execute(context, resProfitAll, ["6001", "6051", "6101", "6111", "6112", "6301"], ["6401", "6402", "6405", "6601", "6602", "6603", "6604", "6701", "6711"]);
      return { resObject };
    } catch (e) {
      throw new Error("执行脚本getCommonProfitH报错：" + e);
    }
  }
}
