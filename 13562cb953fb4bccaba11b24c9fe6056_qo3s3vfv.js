...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker2ai() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker2ai: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker2ai: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DatePicker2a", resultData);
          },
          "formula_customSetValue_formStore_DatePicker2ai" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
