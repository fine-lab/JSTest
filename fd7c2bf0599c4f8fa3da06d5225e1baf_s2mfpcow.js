...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0qe: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0qe: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0qe: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0qe = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0qe = false;
            }
          },
          "interactionRule_visible_formStore_Summary0qe" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
