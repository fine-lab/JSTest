...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let saleReturnSql = "select extendIsWms,bustype.name as bustypeName  from 	pu.purchaseorder.PurchaseOrder where id ='" + param.data[0].id + "' ";
    let saleReturnRes = ObjectStore.queryByYonQL(saleReturnSql, "upu")[0];
    ...
    var strResponse = postman("post", apiRestPre + "/gsp/wmsPurchaseReturnPush", null, JSON.stringify(obj));
    return { strResponse };
  }
}
