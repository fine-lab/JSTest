...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20ye() {},
  formulacustomSetValueDateTimePicker10tb() {},
  formulacustomSetValueDateTimePicker12sa() {},
  formulacustomSetValueInputNumber6pg() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20ye: observable,
  formulacustomSetValueDateTimePicker10tb: observable,
  formulacustomSetValueDateTimePicker12sa: observable,
  formulacustomSetValueInputNumber6pg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20ye: reaction(
      () => [rootStore.formStore.getValue("Input20y")],
      async ([formStore_Input20y]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input20y", resultData);
          },
          "formula_customSetValue_formStore_Input20ye" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker10tb: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker10t", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker10tb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker12sa: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker12s", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker12sa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber6pg: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker12s"), rootStore.formStore.getValue("DateTimePicker10t")],
      async ([formStore_DateTimePicker12s, formStore_DateTimePicker10t]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "dateDiff(DateTimePicker12s,DateTimePicker10t,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker12s,DateTimePicker10t"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber6p",
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber6p", resultData);
          },
          "formula_customSetValue_formStore_InputNumber6pg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
