...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput30oc() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput30oc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input30oc: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("Input30o", resultData);
          },
          "formula_customSetValue_formStore_Input30oc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
