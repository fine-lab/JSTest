...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let minConfig = ObjectStore.selectByMap("GT22176AT10.GT22176AT10.sy01_udi_product_configure2", { id: configId });
    let productUdi = "";
    ...
    let udiCodeList = [];
    //查询生成配置规则
    let configObj = ObjectStore.selectByMap("GT22176AT10.GT22176AT10.sy01_udi_product_configure2", { id: configId });
    let querySql =
      "select * from GT22176AT10.GT22176AT10.sy01_udi_create_config_son where sy01_udi_create_config_id in (select id from GT22176AT10.GT22176AT10.sy01_udi_create_config where id='" +
