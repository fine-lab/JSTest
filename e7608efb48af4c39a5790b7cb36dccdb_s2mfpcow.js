...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleFixedButton0fg() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleFixedButton0fg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_FixedButton0fg: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleFixedButton0fg = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_FixedButton0fg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
