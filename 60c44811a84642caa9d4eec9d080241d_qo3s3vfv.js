...
// 计算属性代码监听开始
let CS02_child1ListStoreExtendRowStore = RowStore;
if (rootStore.CS02_child1ListStore.extendRowStore) {
  CS02_child1ListStoreExtendRowStore = rootStore.CS02_child1ListStore.extendRowStore;
}
class CS02_child1ListStoreRowStore extends CS02_child1ListStoreExtendRowStore {
  constructor() {
    super(...arguments);
    this.formulacustomSetValueInput35rj = undefined;
    this.formulacustomSetValueInputNumber6vc = undefined;
    this.formulacustomSetValueInput37fe = undefined;
    makeObservable(this, {
      formulacustomSetValueInput35rj: observable,
      formulacustomSetValueInputNumber6vc: observable,
      formulacustomSetValueInput37fe: observable
    });
  }
}
rootStore.CS02_child1ListStore.extendRowStore = CS02_child1ListStoreRowStore;
// 扩展新的store
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_CS02_child1ListStore_Input35rj: reaction(
      () => [rootStore.CS02_child1ListStore.getValue().length, rootStore.CS02_child1ListStore.getValue()],
      () => {
        if (!rootStore.CS02_child1ListStore.dismissStack) {
          rootStore.CS02_child1ListStore.dismissStack = [];
        }
        while (rootStore.CS02_child1ListStore.dismissStack.length) {
          rootStore.CS02_child1ListStore.dismissStack.pop();
        }
        rootStore.CS02_child1ListStore.getValue().forEach((rowStore, tableStoreRowIndex) => {
          dismiss = reaction(
            () => [rowStore.getTrueValue("ReferInput1gj")],
            async ([CS02_child1ListStore_ReferInput1gj]) => {
              debounce(
                async () => {
                  const allData = getAllDataByCardStore({
                    rowStore,
                    cardStoreAlias: "cardStore",
                    storeControlType: "TableStore",
                    storeField: "Input35r",
                    storeForm: "",
                    dataSource: "CS02_child1List"
                  });
                  const formulaResult = await countFormula(
                    {
                      hasFormula: "true",
                      formula: "CS02_child1List.ReferInput1gj.unit.name",
                      formulaFuns: "",
                      formulaTriggers: "CS02_child1List.ReferInput1gj.unit.name"
                    },
                    {
                      mainDataSourceAlias: "mainEntity",
                      field: "CS02_child1List.Input35r",
                      billnum: "CS02",
                  ...
                  rowStore.setValue("Input35r", resultData);
                },
                "formula_customSetValue_CS02_child1ListStore_Input35rj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
    ...
    formula_customSetValue_CS02_child1ListStore_InputNumber6vc: reaction(
      () => [rootStore.CS02_child1ListStore.getValue().length, rootStore.CS02_child1ListStore.getValue()],
      () => {
        if (!rootStore.CS02_child1ListStore.dismissStack) {
          rootStore.CS02_child1ListStore.dismissStack = [];
        ...
        rootStore.CS02_child1ListStore.getValue().forEach((rowStore, tableStoreRowIndex) => {
          dismiss = reaction(
            () => [rowStore.getTrueValue("InputNumber1o"), rowStore.getTrueValue("InputNumber4e")],
            async ([CS02_child1ListStore_InputNumber1o, CS02_child1ListStore_InputNumber4e]) => {
              debounce(
                async () => {
                  const allData = getAllDataByCardStore({
                    rowStore,
                  ...
                  const formulaResult = await countFormula(
                    {
                      hasFormula: "true",
                      formula: "CS02_child1List.InputNumber1o*CS02_child1List.InputNumber4e",
                      formulaFuns: "",
                      formulaTriggers: "CS02_child1List.InputNumber1o,CS02_child1List.InputNumber4e"
                    },
                    {
                      mainDataSourceAlias: "mainEntity",
                      field: "CS02_child1List.InputNumber6v",
                      billnum: "CS02",
                      domainKey: "yourKeyHere",
                      allData: allData || {}
                    }
                  ...
                  //对公式结果进行处理
                  const resultData = formulaResult.resultData;
                  rowStore.setValue("InputNumber6v", resultData);
                },
                "formula_customSetValue_CS02_child1ListStore_InputNumber6vc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
    ...
    formula_customSetValue_CS02_child1ListStore_Input37fe: reaction(
      () => [rootStore.CS02_child1ListStore.getValue().length, rootStore.CS02_child1ListStore.getValue()],
      () => {
        if (!rootStore.CS02_child1ListStore.dismissStack) {
          rootStore.CS02_child1ListStore.dismissStack = [];
        ...
        rootStore.CS02_child1ListStore.getValue().forEach((rowStore, tableStoreRowIndex) => {
          dismiss = reaction(
            () => [rowStore.getTrueValue("ReferInput1gj_name")],
            async ([CS02_child1ListStore_ReferInput1gj_name]) => {
              debounce(
                async () => {
                  const allData = getAllDataByCardStore({
                    rowStore,
                  ...
                  const formulaResult = await countFormula(
                    {
                      hasFormula: "true",
                      formula: "CS02_child1List.ReferInput1gj.name",
                      formulaFuns: "",
                      formulaTriggers: "CS02_child1List.ReferInput1gj.name"
                    },
                    {
                      mainDataSourceAlias: "mainEntity",
                      field: "CS02_child1List.Input37f",
                      billnum: "CS02",
                      domainKey: "yourKeyHere",
                      allData: allData || {}
                    }
                  ...
                  //对公式结果进行处理
                  const resultData = formulaResult.resultData;
                  rowStore.setValue("Input37f", resultData);
                },
                "formula_customSetValue_CS02_child1ListStore_Input37fe" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
