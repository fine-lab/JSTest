...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueMobile1ub() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueMobile1ub: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Mobile1ub: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0sk")],
      async ([formStore_UserReferInput0sk]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0sk.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0sk.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Mobile1u", resultData);
          },
          "formula_customSetValue_formStore_Mobile1ub" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
