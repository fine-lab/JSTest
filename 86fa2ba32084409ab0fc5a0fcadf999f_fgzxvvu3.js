...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let sql = "select material,isSku,materialType from GT22176AT10.GT22176AT10.SY01_material_file where org_id  = " + orgId + " and material = " + productId;
    ...
    if (new Date(approvalValidityDate) < new Date()) {
      throw new Error(productName + "批文有效期已过期");
    }
    if (isgspzz) {
