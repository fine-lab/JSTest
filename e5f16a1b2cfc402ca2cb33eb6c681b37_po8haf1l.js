...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    var sql = "select * from 	st.transferapply.TransferApply where code = '" + request.code + "'";
    ...
    let body = { id: res[0].id };
    let header = {};
    var apiResponse = openLinker("get", buzUrl + "/yonbip/scm/transferapply/detail?id=" + res[0].id, "AT19FB439016C80004", JSON.stringify(body));
