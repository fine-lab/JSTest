...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput21tj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput21tj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input21tj: reaction(
      ...
      async ([formStore_UserReferInput0qb]) => {
        debounce(
          ...
          "formula_customSetValue_formStore_Input21tj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
