...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummaryYsy() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummaryYsy: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_SummaryYsy: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummaryYsy = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummaryYsy = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_SummaryYsy" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
