...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput21ib() {},
  formulacustomSetValueInputNumber12sf() {},
  formulacustomSetValueInputNumber23sb() {},
  formulacustomSetValueInputNumber18cf() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput21ib: observable,
  formulacustomSetValueInputNumber12sf: observable,
  formulacustomSetValueInputNumber23sb: observable,
  formulacustomSetValueInputNumber18cf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input21ib: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0fj")],
      async ([formStore_UserReferInput0fj]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0fj.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0fj.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input21i", resultData);
          },
          "formula_customSetValue_formStore_Input21ib" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber12sf: reaction(
      () => [rootStore.formStore.getValue("InputNumber7k"), rootStore.formStore.getValue("InputNumber5w")],
      async ([formStore_InputNumber7k, formStore_InputNumber5w]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber12s",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber7k-InputNumber5w",
                formulaFuns: "",
                formulaTriggers: "InputNumber7k,InputNumber5w"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber12s",
                billnum: "bqbhcsq",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber12s", resultData);
          },
          "formula_customSetValue_formStore_InputNumber12sf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber23sb: reaction(
      () => [rootStore.formStore.getValue("InputNumber12s"), rootStore.formStore.getValue("InputNumber9q")],
      async ([formStore_InputNumber12s, formStore_InputNumber9q]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber23s",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber12s*InputNumber9q",
                formulaFuns: "",
                formulaTriggers: "InputNumber12s,InputNumber9q"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber23s",
                billnum: "bqbhcsq",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber23s", resultData);
          },
          "formula_customSetValue_formStore_InputNumber23sb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber18cf: reaction(
      () => [rootStore.formStore.getValue("InputNumber23s"), rootStore.formStore.getValue("InputNumber14k")],
      async ([formStore_InputNumber23s, formStore_InputNumber14k]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber18c",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber23s+InputNumber14k",
                formulaFuns: "",
                formulaTriggers: "InputNumber23s,InputNumber14k"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber18c",
                billnum: "bqbhcsq",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber18c", resultData);
          },
          "formula_customSetValue_formStore_InputNumber18cf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
