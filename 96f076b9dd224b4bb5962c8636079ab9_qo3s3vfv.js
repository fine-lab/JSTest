...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20eh() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20eh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20eh: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0be")],
      async ([formStore_UserReferInput0be]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("Input20e", resultData);
          },
          "formula_customSetValue_formStore_Input20eh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
