...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker7ae() {},
  formulacustomSetValueDateTimePicker9ue() {},
  formulacustomSetValueInputNumber3bd() {},
  formulacustomSetValueInput19ra() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker7ae: observable,
  formulacustomSetValueDateTimePicker9ue: observable,
  formulacustomSetValueInputNumber3bd: observable,
  formulacustomSetValueInput19ra: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker7ae: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            let result = await countFormula(
              ...
              },
              {
                ...
                field: "DateTimePicker7a",
                billnum: "cheliangshenqinglll",
            ...
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker7a", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker7ae" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9ue: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker9u", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9ue" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber3bd: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9u"), rootStore.formStore.getValue("DateTimePicker7a")],
      async ([formStore_DateTimePicker9u, formStore_DateTimePicker7a]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "dateDiff(DateTimePicker9u,DateTimePicker7a,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9u,DateTimePicker7a"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber3b",
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber3b", resultData);
          },
          "formula_customSetValue_formStore_InputNumber3bd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input19ra: reaction(
      () => [rootStore.formStore.getValue("UserReferInput4jd")],
      async ([formStore_UserReferInput4jd]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput4jd.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput4jd.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input19r",
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("Input19r", resultData);
          },
          "formula_customSetValue_formStore_Input19ra" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
