...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleDescription0oa: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleDescription0oa: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Description0oa: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleDescription0oa = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleDescription0oa = false;
            }
          },
          "interactionRule_visible_formStore_Description0oa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
