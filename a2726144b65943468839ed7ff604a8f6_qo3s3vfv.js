...
// 计算属性代码监听开始
let qzxsdd_2023102701_child1ListStoreExtendRowStore = RowStore;
if (rootStore.qzxsdd_2023102701_child1ListStore.extendRowStore) {
  qzxsdd_2023102701_child1ListStoreExtendRowStore = rootStore.qzxsdd_2023102701_child1ListStore.extendRowStore;
}
class qzxsdd_2023102701_child1ListStoreRowStore extends qzxsdd_2023102701_child1ListStoreExtendRowStore {
  constructor() {
    super(...arguments);
    this.formulacustomSetValueInputNumber5kd = undefined;
    makeObservable(this, {
      formulacustomSetValueInputNumber5kd: observable
    });
  }
}
rootStore.qzxsdd_2023102701_child1ListStore.extendRowStore = qzxsdd_2023102701_child1ListStoreRowStore;
// 扩展新的store
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValue手机号() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValue手机号: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_手机号: reaction(
      () => [rootStore.formStore.getValue("UserReferInput2jg")],
      async ([formStore_UserReferInput2jg]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput2jg.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput2jg.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input34m",
                billnum: "qzxsdd_2023102701",
            ...
            rootStore.formStore.setValue("Input34m", resultData);
          },
          "formula_customSetValue_formStore_手机号" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_qzxsdd_2023102701_child1ListStore_InputNumber5kd: reaction(
      () => [rootStore.qzxsdd_2023102701_child1ListStore.getValue().length, rootStore.qzxsdd_2023102701_child1ListStore.getValue()],
      () => {
        if (!rootStore.qzxsdd_2023102701_child1ListStore.dismissStack) {
          rootStore.qzxsdd_2023102701_child1ListStore.dismissStack = [];
        }
        while (rootStore.qzxsdd_2023102701_child1ListStore.dismissStack.length) {
          rootStore.qzxsdd_2023102701_child1ListStore.dismissStack.pop();
        }
        rootStore.qzxsdd_2023102701_child1ListStore.getValue().forEach((rowStore, tableStoreRowIndex) => {
          dismiss = reaction(
            () => [rowStore.getTrueValue("InputNumber1f"), rowStore.getTrueValue("InputNumber6f")],
            async ([qzxsdd_2023102701_child1ListStore_InputNumber1f, qzxsdd_2023102701_child1ListStore_InputNumber6f]) => {
              debounce(
                async () => {
                  const allData = getAllDataByCardStore({
                    rowStore,
                    ...
                    storeField: "InputNumber5k",
                    storeForm: "",
                    dataSource: "qzxsdd_2023102701_child1List"
                  });
                  const formulaResult = await countFormula(
                    {
                      hasFormula: "true",
                      formula: "qzxsdd_2023102701_child1List.InputNumber1f*qzxsdd_2023102701_child1List.InputNumber6f",
                      formulaFuns: "",
                      formulaTriggers: "qzxsdd_2023102701_child1List.InputNumber1f,qzxsdd_2023102701_child1List.InputNumber6f"
                    },
                    {
                      mainDataSourceAlias: "mainEntity",
                      field: "qzxsdd_2023102701_child1List.InputNumber5k",
                      billnum: "qzxsdd_2023102701",
                      domainKey: "yourKeyHere",
                      allData: allData || {}
                    }
                  ...
                  //对公式结果进行处理
                  const resultData = formulaResult.resultData;
                  rowStore.setValue("InputNumber5k", resultData);
                },
                "formula_customSetValue_qzxsdd_2023102701_child1ListStore_InputNumber5kd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
