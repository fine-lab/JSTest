...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20ff() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20ff: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20ff: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0cc")],
      async ([formStore_UserReferInput0cc]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput0cc.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0cc.mobile"
              },
              {
          ...
          "formula_customSetValue_formStore_Input20ff" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
