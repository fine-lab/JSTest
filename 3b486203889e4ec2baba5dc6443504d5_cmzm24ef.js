...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueinput9() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueinput9: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_input9: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("xm", resultData);
          },
          "formula_customSetValue_formStore_input9" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
