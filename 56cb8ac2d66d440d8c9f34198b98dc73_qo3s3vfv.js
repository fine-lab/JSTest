...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20cf() {},
  formulacustomSetValueInputNumber3li() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20cf: observable,
  formulacustomSetValueInputNumber3li: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20cf: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0jc")],
      async ([formStore_UserReferInput0jc]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput0jc.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0jc.mobile"
              },
              {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input20c", resultData);
          },
          "formula_customSetValue_formStore_Input20cf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber3li: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9i"), rootStore.formStore.getValue("DateTimePicker7t")],
      async ([formStore_DateTimePicker9i, formStore_DateTimePicker7t]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "dateDiff(DateTimePicker9i,DateTimePicker7t,3)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9i,DateTimePicker7t"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber3l",
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber3l", resultData);
          },
          "formula_customSetValue_formStore_InputNumber3li" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
