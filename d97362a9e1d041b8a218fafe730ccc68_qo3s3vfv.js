...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput23pc() {},
  formulacustomSetValueInputNumber4ai() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput23pc: observable,
  formulacustomSetValueInputNumber4ai: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input23pc: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("Input23p", resultData);
          },
          "formula_customSetValue_formStore_Input23pc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber4ai: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber4a", resultData);
          },
          "formula_customSetValue_formStore_InputNumber4ai" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
