...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    try {
      ...
      let proInfo = "select *,product.productDetail.isSerialNoManage from GT22176AT10.GT22176AT10.sy01_udi_product_info where id =  " + configure2Rs[0].sy01_udi_product_info_id + " and dr = 0";
