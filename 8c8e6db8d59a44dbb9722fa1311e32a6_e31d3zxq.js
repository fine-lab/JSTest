viewModel.on("customInit", function (data) {
  var gridModel = viewModel.getGridModel("SY01_durgdestoryv2zList");
  ...
  gridModel
    ...
    .on("beforeBrowse", function () {
      ...
      let product = gridModel.getCellValue(index, "product_code");
      let warehouse = gridModel.getCellValue(index, "deliver_goods_warehouse");
