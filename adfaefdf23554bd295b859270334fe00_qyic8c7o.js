  ...
  execute(context, param) {
    ...
    let body = {
      ...
      webUrl:
        ...
        "/" +
        billData.id +
        "?domainKey=developplatform&apptype=mdf&bipCasTag&taskFlag=todo&typecode=approve&tenantId=qyic8c7o&qzId=307193&source=developplatform&yssource=developplatform&code=${esncode}",
      mUrl:
        "https://www.example.com/" +
        billnum +
        "MobileArchive?mode=browse&_id=" +
        billData.id +
        "&readOnly=true&terminalType=3&taskFlag=todo&typecode=approve&tenantId=qyic8c7o&qzId=307193&code=${esncode}&isReturnNative=true&source=developplatform&yssource=developplatform",
      doneStatus: 0
    };
