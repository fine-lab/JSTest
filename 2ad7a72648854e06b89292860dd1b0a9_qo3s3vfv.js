...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20jc() {},
  formulacustomSetValueDateTimePicker7zc() {},
  formulacustomSetValueDateTimePicker9ei() {},
  formulacustomSetValueInputNumber3od() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20jc: observable,
  formulacustomSetValueDateTimePicker7zc: observable,
  formulacustomSetValueDateTimePicker9ei: observable,
  formulacustomSetValueInputNumber3od: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20jc: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0zf")],
      async ([formStore_UserReferInput0zf]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0zf.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0zf.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input20j",
                billnum: "chenliangshenqingluss",
            ...
            rootStore.formStore.setValue("Input20j", resultData);
          },
          "formula_customSetValue_formStore_Input20jc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker7zc: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker7z", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker7zc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9ei: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker9e", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9ei" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber3od: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9e"), rootStore.formStore.getValue("DateTimePicker7z")],
      async ([formStore_DateTimePicker9e, formStore_DateTimePicker7z]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber3o",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker9e,DateTimePicker7z,3)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9e,DateTimePicker7z"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber3o",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber3o", resultData);
          },
          "formula_customSetValue_formStore_InputNumber3od" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
