...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueUserReferInput9lb_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueUserReferInput9lb_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_UserReferInput9lb_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("UserReferInput9lb", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput9lb_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
