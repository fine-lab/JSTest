...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueUserReferInput2eh_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueUserReferInput2eh_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_UserReferInput2eh_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("UserReferInput2eh", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput2eh_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
