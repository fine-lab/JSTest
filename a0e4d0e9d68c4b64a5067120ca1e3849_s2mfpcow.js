...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisiblemenu01() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisiblemenu01: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_menu01: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisiblemenu01 = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisiblemenu01 = true;
            }
          },
          "interactionRule_visible_formStore_menu01 " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
