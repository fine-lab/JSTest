...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode2ne: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode2ne: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode2ne: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode2ne = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode2ne = false;
            }
          },
          "interactionRule_visible_formStore_QRCode2ne" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
