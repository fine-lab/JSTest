...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let yonql1 =
      "select id,org_id,code,applyType,applydate,applyorg,applydep,applier,purchaser,tradeprice," +
      ...
      "customertypeName,dosageformName,storageConditionsName,curingTypeName,recordNo,zyypStandard,zypfStandard," +
      ...
      "model,registNo,productLincenseNo,registerName,registerAddress,agentName,agentAddress,ccsx,spsx,factory " +
      "from GT22176AT10.GT22176AT10.SY01_fccusauditv4 where dr = 0 and id = '" +
      param.data[0].id +
      "'";
    let res = ObjectStore.queryByYonQL(yonql1, "sy01")[0];
    //查询内容
    let yonql2 = "select id,report,begin_date,end_date,file,reportName,reportCode from GT22176AT10.GT22176AT10.sy01_material_other_report where SY01_fccusauditv4_id = '" + param.data[0].id + "'";
