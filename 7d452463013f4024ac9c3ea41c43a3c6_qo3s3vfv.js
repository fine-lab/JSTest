...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20th() {},
  formulacustomSetValueInputNumber4cj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20th: observable,
  formulacustomSetValueInputNumber4cj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20th: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0zh")],
      async ([formStore_UserReferInput0zh]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0zh.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0zh.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20t", resultData);
          },
          "formula_customSetValue_formStore_Input20th" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber4cj: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8h"), rootStore.formStore.getValue("DateTimePicker6n")],
      async ([formStore_DateTimePicker8h, formStore_DateTimePicker6n]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber4c",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8h,DateTimePicker6n,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8h,DateTimePicker6n"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber4c",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber4c", resultData);
          },
          "formula_customSetValue_formStore_InputNumber4cj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
