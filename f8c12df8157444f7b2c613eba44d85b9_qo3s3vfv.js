...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20dc() {},
  formulacustomSetValueInputNumber0ti() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20dc: observable,
  formulacustomSetValueInputNumber0ti: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20dc: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0ra")],
      async ([formStore_UserReferInput0ra]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0ra.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0ra.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20d", resultData);
          },
          "formula_customSetValue_formStore_Input20dc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber0ti: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8m"), rootStore.formStore.getValue("DateTimePicker6m")],
      async ([formStore_DateTimePicker8m, formStore_DateTimePicker6m]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber0t",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8m,DateTimePicker6m,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8m,DateTimePicker6m"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber0t",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber0t", resultData);
          },
          "formula_customSetValue_formStore_InputNumber0ti" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
