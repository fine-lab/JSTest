...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber10le() {},
  formulacustomSetValueInputNumber14uc() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber10le: observable,
  formulacustomSetValueInputNumber14uc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber10le: reaction(
      () => [rootStore.formStore.getValue("InputNumber6l"), rootStore.formStore.getValue("InputNumber8l")],
      async ([formStore_InputNumber6l, formStore_InputNumber8l]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber6l*InputNumber8l",
                formulaFuns: "",
                formulaTriggers: "InputNumber6l,InputNumber8l"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber10l",
                billnum: "xsrb",
            ...
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber10l", resultData);
          },
          "formula_customSetValue_formStore_InputNumber10le" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber14uc: reaction(
      () => [rootStore.formStore.getValue("InputNumber10l"), rootStore.formStore.getValue("InputNumber12e")],
      async ([formStore_InputNumber10l, formStore_InputNumber12e]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber10l-InputNumber12e",
                formulaFuns: "",
                formulaTriggers: "InputNumber10l,InputNumber12e"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber14u",
                billnum: "xsrb",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber14u", resultData);
          },
          "formula_customSetValue_formStore_InputNumber14uc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
