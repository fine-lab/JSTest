...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleAvatarYsy() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleAvatarYsy: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_AvatarYsy: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleAvatarYsy = true;
            } else if (
              expressionParsing({
                leftValue: formStore_new1,
                operational: "is_null",
              ...
              rootStore.computedAttrStore.interactionRulevisibleAvatarYsy = false;
            }
          },
          "interactionRule_visible_formStore_AvatarYsy" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
