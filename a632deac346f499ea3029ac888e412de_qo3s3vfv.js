...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber7a0ba() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber7a0ba: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber7a0ba: reaction(
      () => [rootStore.formStore.getValue("InputNumber2b"), rootStore.formStore.getValue("InputNumber5c")],
      async ([formStore_InputNumber2b, formStore_InputNumber5c]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber2b*InputNumber5c",
                formulaFuns: "",
                formulaTriggers: "InputNumber2b,InputNumber5c"
              },
              {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber7a", resultData);
          },
          "formula_customSetValue_formStore_InputNumber7a0ba" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
