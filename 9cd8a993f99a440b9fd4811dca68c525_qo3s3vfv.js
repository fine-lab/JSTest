...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker6yc() {},
  formulacustomSetValueInput20yg() {},
  formulacustomSetValueInputNumber2gi() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker6yc: observable,
  formulacustomSetValueInput20yg: observable,
  formulacustomSetValueInputNumber2gi: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker6yc: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              ...
              },
              {
                ...
                field: "DateTimePicker6y",
                billnum: "cheliangshenqingbiao",
            ...
            rootStore.formStore.setValue("DateTimePicker6y", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6yc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input20yg: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0yi")],
      async ([formStore_UserReferInput0yi]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0yi.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0yi.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input20y",
          ...
          "formula_customSetValue_formStore_Input20yg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2gi: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8t"), rootStore.formStore.getValue("DateTimePicker6y")],
      async ([formStore_DateTimePicker8t, formStore_DateTimePicker6y]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber2g",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8t,DateTimePicker6y,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8t,DateTimePicker6y"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2g",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber2g", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2gi" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
