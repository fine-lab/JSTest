...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleIcons0cd: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleIcons0cd: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Icons0cd: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleIcons0cd = false;
            }
          },
          "interactionRule_visible_formStore_Icons0cd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
