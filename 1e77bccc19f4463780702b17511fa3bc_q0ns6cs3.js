...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var access_token = getToken("de397aa47b0e42cca46e4b7eebfe01fa", "953f700e866f4be09061838b17b1919d");
    //获取token方法
    function getToken(extAppKey, extAppSecrect) {
      //设置返回的access_token
      var access_token;
      // 获取token的url
      const token_url = "https://www.example.com/";
      const appkey = extAppKey;
      const appsecrect = extAppSecrect;
      // 当前时间戳
