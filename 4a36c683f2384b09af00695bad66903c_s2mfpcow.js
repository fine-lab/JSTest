...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1yf() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1yf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_TimeLine1yf: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1yf = true;
            } else {
            }
          },
          "interactionRule_visible_unSetStoreAlias_TimeLine1yf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
