...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1sd() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1sd: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_TimeLine1sd: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1sd = true;
            } else {
            }
          },
          "interactionRule_visible_unSetStoreAlias_TimeLine1sd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
