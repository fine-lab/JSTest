...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    // 拼装请求报文
    var obj = { tenantId: tenantid, logId: "test", time: timestampStr, uuid: sign, userId: userId };
    //获取api前缀等信息 参数： 请求方式 ， 地址  ，header ， body
    var strResponse = postman("post", apiPreAndAppCode.apiRestPre + "/task/syncClosedProductStock", null, JSON.stringify(obj));
    return { strResponse };
  }
}
