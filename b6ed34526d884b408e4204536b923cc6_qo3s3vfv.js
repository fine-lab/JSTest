...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput36ui() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput36ui: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input36ui: reaction(
      () => [rootStore.formStore.getValue("Input36u"), rootStore.formStore.getValue("Input34k")],
      async ([formStore_Input36u, formStore_Input34k]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "strToNum(Input36u)-strToNum(Input34k)",
                formulaFuns: "strToNum",
                formulaTriggers: "Input36u,Input34k"
              },
              {
            ...
            rootStore.formStore.setValue("Input36u", resultData);
          },
          "formula_customSetValue_formStore_Input36ui" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
