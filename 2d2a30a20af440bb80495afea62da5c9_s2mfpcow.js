...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTagdaily() {},
  interactionRuledisabledTagdaily() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTagdaily: observable,
  interactionRuledisabledTagdaily: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Tagdaily: reaction(
      ...
      async ([formStore_new1]) => {
        if (
          ...
          rootStore.computedAttrStore.interactionRulevisibleTagdaily = false;
        } else {
          rootStore.computedAttrStore.interactionRulevisibleTagdaily = true;
        }
      },
      {
    ...
    interactionRule_disabled_formStore_Tagdaily: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        if (
          expressionParsing({
          ...
          rootStore.computedAttrStore.interactionRuledisabledTagdaily = true;
        } else {
          rootStore.computedAttrStore.interactionRuledisabledTagdaily = false;
        }
      },
      {
        fireImmediately: true
