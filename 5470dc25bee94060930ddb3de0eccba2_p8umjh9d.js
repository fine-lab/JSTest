...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    // 正确交货方式
    let orderdefinesSql =
      "select id,orderDefineCharacter.attrext14 as define7, orderDefineCharacter.attrext35 as define59, orderDefineCharacter.attrext8 as define2 from voucher.order.Order " +
    ...
    orderdefineList.forEach((item) => {
      ...
      let customersql = "select id, merchantCharacter.attrext40 as define7, merchantCharacter.attrext72 as define8 from aa.merchant.Merchant  where code =" + customerCode;
