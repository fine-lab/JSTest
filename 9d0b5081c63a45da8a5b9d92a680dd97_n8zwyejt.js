...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    for (let i = 0; i < param.data.length; i++) {
      if (
        (typeof param.data[i].bizFlow_name != "undefined" && param.data[i].bizFlow_name.indexOf("销售出库复核") > -1) ||
        (typeof param.data[i].transactionTypeId_name != "undefined" && param.data[i].transactionTypeId_name.indexOf("非GSP") == -1 && param.data[i].transactionTypeId_name.indexOf("GSP") > -1)
      ) {
