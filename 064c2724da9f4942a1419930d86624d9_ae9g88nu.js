      ...
      invokeFunction1(
        ...
        function (err, res) {
          if (typeof res != "undefined") {
            let count = res.count;
            if (count > 0) {
              viewModel.get("extendGSPControlType").setDisabled(true);
            }
          }
        },
        { domainKey: "sy01" }
      ...
      invokeFunction1(
        ...
        function (err, res) {
          if (typeof res != "undefined") {
            let count = res.count;
            if (count > 0) {
              viewModel.get("extendGmpProPreHear").setDisabled(true);
            }
          }
        },
        { domainKey: "sy01" }
      );
      console.log("returnPromise:" + returnPromise.res);
    }
