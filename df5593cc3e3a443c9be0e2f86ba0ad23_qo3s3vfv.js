...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20af() {},
  formulacustomSetValueDateTimePicker9ih() {},
  formulacustomSetValueDateTimePicker7fh() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20af: observable,
  formulacustomSetValueDateTimePicker9ih: observable,
  formulacustomSetValueDateTimePicker7fh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20af: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0bi")],
      async ([formStore_UserReferInput0bi]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput0bi.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0bi.mobile"
              },
              {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input20a", resultData);
          },
          "formula_customSetValue_formStore_Input20af" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9ih: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DateTimePicker9ih" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker7fh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker7f", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker7fh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
