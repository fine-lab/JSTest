...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker6pg() {},
  formulacustomSetValueDateTimePicker8yk() {},
  formulacustomSetValueInputNumber2pk() {},
  formulacustomSetValueInput22zj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker6pg: observable,
  formulacustomSetValueDateTimePicker8yk: observable,
  formulacustomSetValueInputNumber2pk: observable,
  formulacustomSetValueInput22zj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker6pg: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              ...
              },
              {
                ...
                field: "DateTimePicker6p",
                billnum: "chelaingdanganbiao",
            ...
            rootStore.formStore.setValue("DateTimePicker6p", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6pg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker8yk: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker8y", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8yk" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2pk: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8y"), rootStore.formStore.getValue("DateTimePicker6p")],
      async ([formStore_DateTimePicker8y, formStore_DateTimePicker6p]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber2p",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8y,DateTimePicker6p,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8y,DateTimePicker6p"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2p",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber2p", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2pk" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input22zj: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0vg")],
      async ([formStore_UserReferInput0vg]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0vg.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0vg.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input22z",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input22z", resultData);
          },
          "formula_customSetValue_formStore_Input22zj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
