...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let productSku = materialObj[0].productSku;
    ...
    for (let i = 0; i < udiCodeList.length; i++) {
      ...
      let udiTrack = { _status: "Insert", trackingDirection: "生成", billNo: billCode, material: material, productSku: productSku, unit: unitName, qty: maxCreateUdiNum };
