...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let audiYonql = "select id,org_id,code,customer from 	GT22176AT10.GT22176AT10.SY01_firstcampcusv3 where dr = 0 and id = '" + param.data[0].id + "'";
    ...
    // 拼装请求报文
    var obj = { tenantId: tenantid, logId: "yourIdHere", time: timestampStr, type: "1", uuid: sign, orgId: auditRes.org_id, clientId: auditRes.customer, userId: ObjectStore.user().id };
