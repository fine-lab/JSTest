...
class MyTrigger extends AbstractTrigger {
  execute(context, functionTarget) {
    try {
      ...
      // 获取一年前值
      let funcOneYearAgoDate = new Date().getFullYear() - 1;
      ...
      // 获取两年前值
      let funcTwoYearAgoDate = new Date().getFullYear() - 2;
      ...
      // 获取三年前值
      let funcThreeYearAgoDate = new Date().getFullYear() - 3;
      ...
      // 获取四年前值
      let funcFourYearAgoDate = new Date().getFullYear() - 4;
      ...
      throw new Error("执行脚本getTarget报错：" + e);
    }
  }
}
