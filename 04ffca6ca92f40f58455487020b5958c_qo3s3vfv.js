...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueReferInput4pc_refer() {},
  formulacustomSetValueReferInput6hj_refer() {},
  formulacustomSetValueReferInput8og_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueReferInput4pc_refer: observable,
  formulacustomSetValueReferInput6hj_refer: observable,
  formulacustomSetValueReferInput8og_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_ReferInput4pc_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput4pc", resultData);
          },
          "formula_customSetValue_formStore_ReferInput4pc_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput6hj_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput6hj", resultData);
          },
          "formula_customSetValue_formStore_ReferInput6hj_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput8og_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput8og", resultData);
          },
          "formula_customSetValue_formStore_ReferInput8og_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
