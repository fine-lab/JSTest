...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleText0oe: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleText0oe: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Text0oe: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleText0oe = false;
            }
          },
          "interactionRule_visible_formStore_Text0oe" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
