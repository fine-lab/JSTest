...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20sd() {},
  formulacustomSetValueInputNumber6yf() {},
  formulacustomSetValueDateTimePicker10ne() {},
  formulacustomSetValueDateTimePicker12md() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20sd: observable,
  formulacustomSetValueInputNumber6yf: observable,
  formulacustomSetValueDateTimePicker10ne: observable,
  formulacustomSetValueDateTimePicker12md: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20sd: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0lg")],
      async ([formStore_UserReferInput0lg]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0lg.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0lg.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20s", resultData);
          },
          "formula_customSetValue_formStore_Input20sd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber6yf: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker12m"), rootStore.formStore.getValue("DateTimePicker10n")],
      async ([formStore_DateTimePicker12m, formStore_DateTimePicker10n]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber6y",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker12m,DateTimePicker10n,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker12m,DateTimePicker10n"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber6y",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber6y", resultData);
          },
          "formula_customSetValue_formStore_InputNumber6yf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker10ne: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker10n", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker10ne" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker12md: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker12m", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker12md" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
