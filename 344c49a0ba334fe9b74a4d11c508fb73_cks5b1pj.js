...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    try {
      ...
      var getsubjects = {};
      var subjects = [];
      subjects = ObjectStore.selectByMap("AT17AF88F609C00004.AT17AF88F609C00004.subjects", getsubjects);
      ...
      var getAllSubjects = {};
      var allSubjects = [];
      allSubjects = ObjectStore.selectByMap("AT17AF88F609C00004.AT17AF88F609C00004.allsubjects", getAllSubjects);
