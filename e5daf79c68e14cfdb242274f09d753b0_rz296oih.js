...
viewModel.getGridModel().on("beforeSetDataSource", function (data) {
  debugger;
  // 按资产开始使用时间进行过滤
  let sn = viewModel.getCache("FilterViewModel").get("sn").getFromModel().getValue();
  let beginUseDate = viewModel.getCache("FilterViewModel").get("useDate").getFromModel().getValue();
  let endUseDate = viewModel.getCache("FilterViewModel").get("useDate").getToModel().getValue();
  // 按到货日期进行过滤
  let beginArriveDate = viewModel.getCache("FilterViewModel").get("arriveDate").getFromModel().getValue();
  let endArriveDate = viewModel.getCache("FilterViewModel").get("arriveDate").getToModel().getValue();
