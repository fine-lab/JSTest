let djInfoTable = viewModel.get("UDIShowDjInfo3List"); //单据列表
let waiBjInfoList = viewModel.get("UDIShowWaiBjInfo3List"); //外包装信息表
let zhongBjInfoList = viewModel.get("UDIShowZhongBjInfo3List"); //中包装信息表
let ziBjInfoList = viewModel.get("UDIShowZiBjInfo3List"); //zi包装信息表
...
viewModel.get("UDIShowDjInfo3List") &&
  viewModel.get("UDIShowDjInfo3List").on("afterSelect", function (rowIndexs) {
    // 表格1--选择后
...
viewModel.get("UDIShowZhongBjInfo3List") &&
  viewModel.get("UDIShowZhongBjInfo3List").on("afterSelect", function (rowIndexs) {
    // 表格1--中包装选择后
