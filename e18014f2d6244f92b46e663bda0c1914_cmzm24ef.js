...
// 方法改成计算方法
const computedAttr = {
  formulaurlIframe0pg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_url_formStore_Iframe0pg: reaction(
      ...
      async ([formStore_wenben]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.computedAttrStore.formulaurlIframe0pg = resultData;
          },
          "formula_url_formStore_Iframe0pg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
