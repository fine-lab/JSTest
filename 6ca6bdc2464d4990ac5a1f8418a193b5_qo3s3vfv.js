...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20xh() {},
  formulacustomSetValueDateTimePicker6te() {},
  formulacustomSetValueDateTimePicker8xk() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20xh: observable,
  formulacustomSetValueDateTimePicker6te: observable,
  formulacustomSetValueDateTimePicker8xk: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20xh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0be.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0be.mobile"
              },
              {
          ...
          "formula_customSetValue_formStore_Input20xh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker6te: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker6t", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6te" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker8xk: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker8x", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8xk" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
