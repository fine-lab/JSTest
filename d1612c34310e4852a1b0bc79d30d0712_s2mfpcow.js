...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1nc() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1nc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_TimeLine1nc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1nc = true;
            } else {
            }
          },
          "interactionRule_visible_unSetStoreAlias_TimeLine1nc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
