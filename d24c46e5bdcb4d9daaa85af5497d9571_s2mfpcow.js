...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0ak: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0ak: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0ak: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0ak = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0ak = false;
            }
          },
          "interactionRule_visible_formStore_Summary0ak" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
