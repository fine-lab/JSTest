...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0se() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0se: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Summary0se: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0se = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0se = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Summary0se" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
