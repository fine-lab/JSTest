...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Userdefinegroup1rc_zy120501: reaction(
      () => [rootStore.formStore.getValue("feature.zy120502"), rootStore.formStore.getValue("feature.zy120503")],
      async ([formStore_feature_zy120502, formStore_feature_zy120503]) => {
        debounce(
          async () => {
