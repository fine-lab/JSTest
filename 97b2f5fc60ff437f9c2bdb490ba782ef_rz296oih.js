...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    throw new Error(JSON.stringify(syncParam));
    //获取配置信息
    ...
    // 同步中外运
    let saveLog = {};
    saveLog.methodName = "syncLogistatics";
    ...
    saveLog.requestParams = JSON.stringify(node);
