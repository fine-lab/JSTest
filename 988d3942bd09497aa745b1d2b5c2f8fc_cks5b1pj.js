...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    try {
      var org = request.org;
      var vouchdate = request.period2;
      // 获取本期销售价格  数量
      var sql1 =
        "select code,vouchdate,t1.oriSum,t1.qty from voucher.order.Order left join voucher.order.OrderDetail t1  on id=t1.orderId where salesOrgId ='" +
        org +
        "' and vouchdate leftlike '" +
        vouchdate +
        "'";
      ...
      throw new Error("执行脚本getSales报错：" + e);
    }
  }
}
