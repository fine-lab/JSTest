...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    saleordersChildList.forEach((item) => {
      ...
      let id = item.id; //子表id
      let saleOrderDefineSql = "select id, orderDetailDefineCharacter.attrext19 as define8, orderDetailDefineCharacter.attrext27 as define17 from voucher.order.OrderDetail where id=" + id;
      ...
      if (define17) {
        //根据参考行号  查询采购入库子表id
        let PurInRecordsDefineSql = "select  id  from  st.purinrecord.PurInRecords where  purInRecordsDefineCharacter.attrext35 ='" + define17 + "'";
    ...
    function updateSalesOrder(mainid, id, batchNo) {
      ...
      let object = {
        data: {
          ...
          payMoney: payMoney,
          agentId: agentId,
          "orderPrices!currency": "1864068780970737669", //TODO线上需要修改为 1503986342142935064
          transactionTypeId: transactionTypeId,
          settlementOrgId: salesOrgId,
          "orderPrices!orderId": mainid,
          "orderPrices!exchRate": 1,
          "orderPrices!exchangeRateType": "mwt087m1", //TODO线上需要修改为 p8umjh9d
          "orderPrices!natCurrency": "1864068780970737669", //TODO线上需要修改为 1503986342142935064
