...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleDescription0ef() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleDescription0ef: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Description0ef: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleDescription0ef = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleDescription0ef = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Description0ef" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
