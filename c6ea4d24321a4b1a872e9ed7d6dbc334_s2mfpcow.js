...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleIcons0ya() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleIcons0ya: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Icons0ya: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleIcons0ya = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Icons0ya" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
