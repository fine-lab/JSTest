...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker0lf() {},
  formulacustomSetValueDateTimePicker7rg() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker0lf: observable,
  formulacustomSetValueDateTimePicker7rg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker0lf: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DatePicker0lf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker7rg: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DateTimePicker7rg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
