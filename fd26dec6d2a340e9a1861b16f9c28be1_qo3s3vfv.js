...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20md() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20md: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20md: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "creator.mobile",
                formulaFuns: "",
                formulaTriggers: "creator.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input20m",
                billnum: "yizucheliangshenqing",
            ...
            rootStore.formStore.setValue("Input20m", resultData);
          },
          "formula_customSetValue_formStore_Input20md" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
