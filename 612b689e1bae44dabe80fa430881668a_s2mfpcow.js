...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode0qh: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode0qh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode0qh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode0qh = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode0qh = false;
            }
          },
          "interactionRule_visible_formStore_QRCode0qh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
