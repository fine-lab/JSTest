...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let yonql =
      "select id,leaderName,contactTel,fax,scope,businessLicenseNo,personCharge,address regAddress,enterpriseNature,creditCode,businessterm from aa.merchant.Merchant where id = '" +
      request.customerId +
      "'";
