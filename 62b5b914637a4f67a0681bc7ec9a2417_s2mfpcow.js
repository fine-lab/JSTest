...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibletagpc() {},
  interactionRuledisabledtagpc() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibletagpc: observable,
  interactionRuledisabledtagpc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_tagpc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibletagpc = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibletagpc = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_tagpc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    interactionRule_disabled_unSetStoreAlias_tagpc: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRuledisabledtagpc = true;
            } else {
              rootStore.computedAttrStore.interactionRuledisabledtagpc = false;
            }
          },
          "interactionRule_disabled_unSetStoreAlias_tagpc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
