...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleAvatar0ze: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleAvatar0ze: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Avatar0ze: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleAvatar0ze = true;
            } else if (
              expressionParsing({
                leftValue: formStore_new1,
                operational: "is_null",
              ...
              rootStore.computedAttrStore.interactionRulevisibleAvatar0ze = false;
            }
          },
          "interactionRule_visible_formStore_Avatar0ze" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
