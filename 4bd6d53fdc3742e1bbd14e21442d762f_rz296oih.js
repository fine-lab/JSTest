...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let id = data.id;
    let active = data.pushFlag == "2" ? "1" : "0";
    let yonQl =
    ...
    res.map((item, i) => {
      ...
      //订单状态 0:作废，1:新增"
      sysObj.active = active;
      //组织
      officeName.officeName = "";
      //合同号
      officeName.contractNumber = "";
      //客户项目名称
      officeName.custProjectName = "";
      //表体字段
      let details = [];
    ...
    let saveLog = {};
    saveLog.methodName = "syncDeliveryApi";
    ...
    saveLog.errorMsg = apiResponse.err;
    saveLog.url = url;
