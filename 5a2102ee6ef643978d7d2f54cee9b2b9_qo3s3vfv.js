...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20fg() {},
  formulacustomSetValueInputNumber5id() {},
  formulacustomSetValueInputNumber9zc() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20fg: observable,
  formulacustomSetValueInputNumber5id: observable,
  formulacustomSetValueInputNumber9zc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20fg: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0yb")],
      async ([formStore_UserReferInput0yb]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0yb.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0yb.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20f", resultData);
          },
          "formula_customSetValue_formStore_Input20fg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber5id: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker11i"), rootStore.formStore.getValue("DateTimePicker9o")],
      async ([formStore_DateTimePicker11i, formStore_DateTimePicker9o]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber5i",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker11i,DateTimePicker9o,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker11i,DateTimePicker9o"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber5i",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber5i", resultData);
          },
          "formula_customSetValue_formStore_InputNumber5id" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber9zc: reaction(
      () => [rootStore.formStore.getValue("ReferInput3ei")],
      async ([formStore_ReferInput3ei]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber9z",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "ReferInput3ei.InputNumber3p",
                formulaFuns: "",
                formulaTriggers: "ReferInput3ei.InputNumber3p"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber9z",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber9z", resultData);
          },
          "formula_customSetValue_formStore_InputNumber9zc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
