...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    res.map((item, i) => {
      let syncParam = {};
      //供应商工厂代码
      syncParam.vdFactoryCode = funRes.BASE.FACTORY_CODE;
      // 客户代码
      syncParam.customerVendorCode = funRes.BASE.SUPPLIER_CODE;
      ...
      // 华为指定供应商Code
      syncParam.componentVendorCode = funRes.BASE.SUPPLIER_CODE;
      let saveLog = {};
