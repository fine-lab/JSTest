...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1dh() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1dh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_TimeLine1dh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1dh = true;
            } else {
            }
          },
          "interactionRule_visible_formStore_TimeLine1dh " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
