...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker16ef() {},
  formulacustomSetValueInputNumber10ic() {},
  formulacustomSetValueInputNumber12fa() {},
  formulacustomSetValueInputNumber16xh() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker16ef: observable,
  formulacustomSetValueInputNumber10ic: observable,
  formulacustomSetValueInputNumber12fa: observable,
  formulacustomSetValueInputNumber16xh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker16ef: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker16e", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker16ef" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber10ic: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker13q"), rootStore.formStore.getValue("DateTimePicker16e")],
      async ([formStore_DateTimePicker13q, formStore_DateTimePicker16e]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber10i",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker13q,DateTimePicker16e,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker13q,DateTimePicker16e"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber10i",
                billnum: "SLC007",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber10i", resultData);
          },
          "formula_customSetValue_formStore_InputNumber10ic" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber12fa: reaction(
      () => [
        rootStore.formStore.getValue("ReferInput6zd"),
        rootStore.formStore.getValue("ReferInput6zd_ReferInput3ei"),
        rootStore.formStore.getValue("ReferInput6zd_ReferInput3ei"),
        rootStore.formStore.getValue("InputNumber16x")
      ],
      async ([formStore_ReferInput6zd, formStore_ReferInput6zd_ReferInput3ei, formStore_ReferInput6zd_ReferInput3ei, formStore_InputNumber16x]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber12f",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "ReferInput6zd.InputNumber5i*ReferInput6zd.ReferInput3ei.InputNumber4s+ReferInput6zd.ReferInput3ei.InputNumber2n*InputNumber16x",
                formulaFuns: "",
                formulaTriggers: "ReferInput6zd.InputNumber5i,ReferInput6zd.ReferInput3ei.InputNumber4s,ReferInput6zd.ReferInput3ei.InputNumber2n,InputNumber16x"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber12f",
                billnum: "SLC007",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber12f", resultData);
          },
          "formula_customSetValue_formStore_InputNumber12fa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber16xh: reaction(
      () => [rootStore.formStore.getValue("InputNumber14t"), rootStore.formStore.getValue("InputNumber7s")],
      async ([formStore_InputNumber14t, formStore_InputNumber7s]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber16x",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber14t-InputNumber7s",
                formulaFuns: "",
                formulaTriggers: "InputNumber14t,InputNumber7s"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber16x",
                billnum: "SLC007",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber16x", resultData);
          },
          "formula_customSetValue_formStore_InputNumber16xh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
