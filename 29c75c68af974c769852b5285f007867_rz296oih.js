...
viewModel.on("beforeSearch", function (args) {
  ...
  cb.rest.invokeFunction("AT160194EA17D00009.apiFun.priceSettleQuery", { opDate: opDate, firstDate: firstDate, firstNextDate: firstNextDate }, function (err, res) {
    debugger;
    let purdata = res.purInRecordData;
    viewModel.getGridModel().setState("dataSourceMode", "local");
    if (purdata) {
      let total = purdata.length;
