...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker7mj() {},
  formulacustomSetValueInputNumber3jg() {},
  formulacustomSetValueInput19gb() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker7mj: observable,
  formulacustomSetValueInputNumber3jg: observable,
  formulacustomSetValueInput19gb: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker7mj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker7m", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker7mj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber3jg: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9u"), rootStore.formStore.getValue("DateTimePicker7m")],
      async ([formStore_DateTimePicker9u, formStore_DateTimePicker7m]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber3j",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker9u,DateTimePicker7m,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9u,DateTimePicker7m"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber3j",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber3j", resultData);
          },
          "formula_customSetValue_formStore_InputNumber3jg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input19gb: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0xf")],
      async ([formStore_UserReferInput0xf]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0xf.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0xf.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input19g",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input19g", resultData);
          },
          "formula_customSetValue_formStore_Input19gb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
