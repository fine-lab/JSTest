...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleIcons0hh: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleIcons0hh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Icons0hh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleIcons0hh = false;
            }
          },
          "interactionRule_visible_formStore_Icons0hh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
