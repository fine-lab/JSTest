...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisiblebreadcrumbpc() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisiblebreadcrumbpc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_breadcrumbpc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisiblebreadcrumbpc = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisiblebreadcrumbpc = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_breadcrumbpc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
