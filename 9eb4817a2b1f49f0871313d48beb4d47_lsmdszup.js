viewModel.on("customInit", function (data) {
  ...
  let updateViewModel = function (gridModelInfo, i, materialInfo) {
    ...
    let isBatch = true; //getSwitchValue(materialInfo.isBatchManage);
    let isValid = true; //getSwitchValue(materialInfo.isExpiryDateManage);
    ...
    if (isBatch == 0) {
      ...
      gridModelInfo.setColumnState("item139ld_batchno", "bCanModify", true);
      gridModelInfo.setColumnState("batch_no", "bCanModify", true);
    }
  };
