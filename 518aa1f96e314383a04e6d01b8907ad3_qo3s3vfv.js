...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber11kc() {},
  formulacustomSetValueInputNumber15sj() {},
  formulacustomSetValueDatePicker1zj() {},
  formulacustomSetValueReferInput1dc_refer() {},
  formulacustomSetValueReferInput2eg_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber11kc: observable,
  formulacustomSetValueInputNumber15sj: observable,
  formulacustomSetValueDatePicker1zj: observable,
  formulacustomSetValueReferInput1dc_refer: observable,
  formulacustomSetValueReferInput2eg_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber11kc: reaction(
      () => [rootStore.formStore.getValue("InputNumber7b"), rootStore.formStore.getValue("InputNumber9b")],
      async ([formStore_InputNumber7b, formStore_InputNumber9b]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber7b*InputNumber9b",
                formulaFuns: "",
                formulaTriggers: "InputNumber7b,InputNumber9b"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber11k",
                billnum: "xsrb",
            ...
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber11k", resultData);
          },
          "formula_customSetValue_formStore_InputNumber11kc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber15sj: reaction(
      () => [rootStore.formStore.getValue("InputNumber11k"), rootStore.formStore.getValue("InputNumber13x")],
      async ([formStore_InputNumber11k, formStore_InputNumber13x]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber11k-InputNumber13x",
                formulaFuns: "",
                formulaTriggers: "InputNumber11k,InputNumber13x"
              },
              {
                mainDataSourceAlias: "mainEntity",
          ...
          "formula_customSetValue_formStore_InputNumber15sj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DatePicker1zj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DatePicker1z", resultData);
          },
          "formula_customSetValue_formStore_DatePicker1zj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput1dc_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput1dc", resultData);
          },
          "formula_customSetValue_formStore_ReferInput1dc_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput2eg_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput5fk", resultData);
          },
          "formula_customSetValue_formStore_ReferInput2eg_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
