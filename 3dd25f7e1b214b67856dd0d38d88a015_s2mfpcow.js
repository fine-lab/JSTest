...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput17qe() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput17qe: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input17qe: reaction(
      () => [],
      async ([]) => {
        ...
        rootStore.formStore.setValue("Input17q", resultData);
      },
      {
