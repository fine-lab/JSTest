...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0gh: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0gh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0gh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0gh = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0gh = false;
            }
          },
          "interactionRule_visible_formStore_Summary0gh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
