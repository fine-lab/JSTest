        ...
        if (item.line_data.length > 0) {
          item.line_data.forEach((line, indexLine) => {
            ...
            for (var i in res) {
              ...
              shippingscheduleb.orderType = line.orderType;
              shippingscheduleb.replenishmentItemSn = line.replenishmentItemSn;
              shippingscheduleb.replenishmentRemark = line.replenishmentRemark;
              shippingscheduleb.projectName = line.projectName;
              shippingscheduleb.originalOrderHeaderNum = line.originalOrderHeaderNum;
              shippingscheduleb.defectiveItemCode = line.defectiveItemCode;
              shippingscheduleb.defectiveSn = line.defectiveSn;
              shippingscheduleb.oriOrderHeaderDesc = line.oriOrderHeaderDesc;
              shippingscheduleb.entireDeviceCode = line.prodentireDeviceCodeuct_volume;
              shippingscheduleb.mainEquipmentSn = line.mainEquipmentSn;
              shippingscheduleb.defectiveAsd = line.prodefectiveAsdduct_volume;
              shippingscheduleb.defectiveAta = line.defectiveAta;
              shippingscheduleb.shippedServersQty = line.shippedServersQty;
              ...
              var uploadData = {
                ...
                replenishmentItemSn: line.replenishmentItemSn,
                replenishmentRemark: line.replenishmentRemark,
                projectName: line.projectName,
                originalOrderHeaderNum: line.originalOrderHeaderNum,
                defectiveItemCode: line.defectiveItemCode,
                defectiveSn: line.defectiveSn,
                oriOrderHeaderDesc: line.oriOrderHeaderDesc,
                entireDeviceCode: line.entireDeviceCode,
                mainEquipmentSn: line.mainEquipmentSn,
                defectiveAsd: line.defectiveAsd,
                defectiveAta: line.defectiveAta,
                orderType: line.orderType,
                shippedServersQty: line.shippedServersQty
              };
              if (res[i].deviceSupplier == "SS" || res[i].deviceSupplier == "ZR") {
