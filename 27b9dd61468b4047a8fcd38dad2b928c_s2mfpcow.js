...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_DescriptionYsy: reaction(
      ...
      async ([formStore_new1]) => {
        debounce(
          ...
          "interactionRule_visible_formStore_DescriptionYsy " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
