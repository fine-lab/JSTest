...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueinputnumber50() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueinputnumber50: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_inputnumber50: reaction(
      () => [rootStore.formStore.getValue("danjiayuanmu"), rootStore.formStore.getValue("shuliangmu")],
      async ([formStore_danjiayuanmu, formStore_shuliangmu]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "danjiayuanmu*shuliangmu",
                formulaFuns: "",
                formulaTriggers: "danjiayuanmu,shuliangmu"
              },
              {
            ...
            rootStore.formStore.setValue("jineyuan", resultData);
          },
          "formula_customSetValue_formStore_inputnumber50" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
