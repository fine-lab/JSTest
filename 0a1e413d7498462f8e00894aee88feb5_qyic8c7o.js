viewModel.get("button13fg") &&
  viewModel.get("button13fg").on("click", function (data) {
    // 确认--单击
...
viewModel.get("button15vj") &&
  viewModel.get("button15vj").on("click", function (data) {
    // 驳回--单击
    const row = viewModel.getGridModel().getAllData()[data.index];
    if (row.status == "转移中") {
      const obj = {
...
const instrayArr = [
  ...
  },
  {
    instray: "消费品",
    code: "1030",
    userId: ["125869", "77d6a511-663f-48cb-bb5c-1b40ce86b531", "2b607c6e-5b83-4256-83ee-eaa7906b2a1a", "1073ed86-7a3e-4b6c-98f5-fc43052ccc92"]
  },
  {
    instray: "流程制造",
    code: "1040",
    userId: ["120560", "6a8d57ba-f45c-483a-93cd-7aad92e68f70"]
  },
  {
    instray: "钢铁冶金",
    code: "1050",
    userId: ["a713f474-ca3a-4387-b7dc-dee323c61437", "e846d541-9144-4b61-9941-7eed8153f6a5", "uspace_386725", "51a79037-a393-4521-b523-6a962d5b4dd3", "4f207226-aa49-4998-8e5b-55e4f8e07677"]
  },
  {
    instray: "工业化工与造纸",
    code: "1060",
    userId: ["51444997-0ca9-43b2-876a-5d3e1f77d5bc", "176d3a20-4758-4081-b0b9-a9fb4f82cd0d", "6b20a375-62a8-4a67-8133-64c8295ef245"]
  },
  {
    instray: "制药与医药流通",
    code: "1070",
  ...
  },
  {
    instray: "食品饮料",
    code: "1080",
    userId: ["120730", "f2381a04-a112-4bc7-ae13-0311d83ab044"]
  },
  {
    instray: "酒业",
    code: "1090",
    userId: ["413ab5e8-437a-4e8e-983a-712b25c01ba4", "552055", "b51f3a30-3e57-4e05-a908-4a048c699533"]
  },
  {
    instray: "装备制造",
    code: "1100",
  ...
  },
  {
    ...
    code: "1150",
    userId: [
      "d1483cb8-dc9a-4246-8ced-5f57006a46f4",
      "6696abdf-5c85-4edf-bdeb-7565520f1189",
      "a00a4ccf-a5f1-47c0-99b3-38c248b17eea",
      "09ead2f5-335c-4118-bc21-726428e5afd7",
      "3a108362-00d7-4fb4-94ec-b70f45c1ed05",
      "cb49fc96-43fd-488a-b5ef-56ec93d372d4"
    ]
  },
  {
    instray: "地产",
    code: "1160",
    userId: [
      "caa3c9e3-5cb0-4ec6-8fcf-d7cad447eb03",
      "c4a22c8a-1b56-4358-b425-64a73ae3ef75",
      "1e6fa5b0-a9d7-4a38-bbfb-1a82014a1b41",
      "668edaa0-2765-4211-a805-1093764551e5",
      "ec123031-4cae-47fb-a09a-30443d3bffd7"
    ]
  },
  {
    instray: "现代服务",
    code: "1170",
    userId: ["8318f5fd-1467-4611-a1e0-3deedf19681c", "105187", "a98c8d2f-700b-469c-baa5-7622b33f2c22", "34dc2148-684a-49e0-87e2-c9c449803475"]
  },
  {
    instray: "医疗",
    code: "1180",
  ...
  },
  {
    ...
    code: "1190",
    userId: [
      "8063b2b2-4c90-405d-a60f-f7a29866c881",
      "f0d24217-9d1c-49c7-98a9-74c8ae322a53",
      "121109",
      "185036eb-ad1f-490b-9895-17cfe643ca97",
      "fadd4e77-5b4f-4f42-a4c9-587f5a185f76",
      "449f448c-ccb8-4115-a69d-56077f159d71"
    ]
  },
  {
    instray: "互联网",
  ...
  },
  {
    instray: "零售分销",
    code: "1300",
    userId: ["8725d5ed-20a6-4084-80fd-6cbe509531d5", "6837caea-d1e3-4885-872b-6f09881c4aaa", "3a149bd8-2413-472d-9fab-d8abe371ee1c"]
  }
];
...
viewModel.get("project_transfer_base_1660674797876543497") &&
  viewModel.get("project_transfer_base_1660674797876543497").on("afterSetDataSource", function (data) {
    // 表格--设置数据源后
    cb.rest.invokeFunction("AT16AD797616380008.API.getRole", {}, function (err, res) {
      const userId = viewModel.getAppContext().user.userId;
      if (!err) {
        const data = JSON.parse(res.apiResponse).data.list.map((item) => item.yhtUserId);
        debugger;
        viewModel.getGridModel().setColumnState("q1TaskMoney", "bShowIt", data.includes(userId));
      }
    });
  });
viewModel.on("customInit", function (data) {
