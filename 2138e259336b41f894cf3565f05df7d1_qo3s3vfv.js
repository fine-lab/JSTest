...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker0lk() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker0lk: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker0lk: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DatePicker0lk" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
