...
// 计算属性代码监听开始
let yzez231124whan1_zi01ListStoreExtendRowStore = RowStore;
if (rootStore.yzez231124whan1_zi01ListStore.extendRowStore) {
  yzez231124whan1_zi01ListStoreExtendRowStore = rootStore.yzez231124whan1_zi01ListStore.extendRowStore;
}
class yzez231124whan1_zi01ListStoreRowStore extends yzez231124whan1_zi01ListStoreExtendRowStore {
  constructor() {
    super(...arguments);
    this.interactionRulevisibletimepicker132 = undefined;
    this.interactionRulevisiblereferinput128 = undefined;
    makeObservable(this, {
      interactionRulevisibletimepicker132: observable,
      interactionRulevisiblereferinput128: observable
    });
  }
}
rootStore.yzez231124whan1_zi01ListStore.extendRowStore = yzez231124whan1_zi01ListStoreRowStore;
// 扩展新的store
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_yzez231124whan1_zi01ListStore_timepicker132: reaction(
      () => [rootStore.yzez231124whan1_zi01ListStore.getValue().length, rootStore.yzez231124whan1_zi01ListStore.getValue()],
      () => {
        if (!rootStore.yzez231124whan1_zi01ListStore.dismissStack) {
          rootStore.yzez231124whan1_zi01ListStore.dismissStack = [];
        }
        while (rootStore.yzez231124whan1_zi01ListStore.dismissStack.length) {
          rootStore.yzez231124whan1_zi01ListStore.dismissStack.pop();
        }
        rootStore.yzez231124whan1_zi01ListStore.getValue().forEach((rowStore, tableStoreRowIndex) => {
          dismiss = reaction(
            () => [rootStore.formStore.getValue("zhengshu")],
            async ([formStore_zhengshu]) => {
              debounce(
                async () => {
                  if (
                    expressionParsing({
                      leftValue: formStore_zhengshu,
                      operational: "eq",
                      rightValue: "1",
                      extLeftValue: {
                        bizType: "number"
                    ...
                    rowStore.interactionRulevisibletimepicker132 = false;
                  }
                },
                "interactionRule_visible_yzez231124whan1_zi01ListStore_timepicker132" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
    ...
    interactionRule_visible_yzez231124whan1_zi01ListStore_referinput128: reaction(
      () => [rootStore.yzez231124whan1_zi01ListStore.getValue().length, rootStore.yzez231124whan1_zi01ListStore.getValue()],
      () => {
        if (!rootStore.yzez231124whan1_zi01ListStore.dismissStack) {
          rootStore.yzez231124whan1_zi01ListStore.dismissStack = [];
              ...
              debounce(
                async () => {
                  if (
                    ...
                    rowStore.interactionRulevisiblereferinput128 = false;
                  }
                },
                "interactionRule_visible_yzez231124whan1_zi01ListStore_referinput128" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
                300
              )();
            },
            {
