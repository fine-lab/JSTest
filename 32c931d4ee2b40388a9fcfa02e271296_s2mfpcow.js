...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleBreadcrumb0be: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleBreadcrumb0be: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Breadcrumb0be: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0be = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0be = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Breadcrumb0be" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
