...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTag0zj: null,
  interactionRuledisabledTag0zj: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTag0zj: observable,
  interactionRuledisabledTag0zj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Tag0zj: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTag0zj = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleTag0zj = true;
            }
          },
          "interactionRule_visible_formStore_Tag0zj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    interactionRule_disabled_formStore_Tag0zj: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRuledisabledTag0zj = true;
            } else {
              rootStore.computedAttrStore.interactionRuledisabledTag0zj = false;
            }
          },
          "interactionRule_disabled_formStore_Tag0zj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
