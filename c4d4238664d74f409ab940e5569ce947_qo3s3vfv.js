...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber8ub() {},
  formulacustomSetValueDateTimePicker9aj() {},
  formulacustomSetValueInputNumber6od() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber8ub: observable,
  formulacustomSetValueDateTimePicker9aj: observable,
  formulacustomSetValueInputNumber6od: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber8ub: reaction(
      () => [rootStore.formStore.getValue("InputNumber4u"), rootStore.formStore.getValue("InputNumber6o")],
      async ([formStore_InputNumber4u, formStore_InputNumber6o]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "InputNumber4u*InputNumber6o",
                formulaFuns: "",
                formulaTriggers: "InputNumber4u,InputNumber6o"
              },
              {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber8u", resultData);
          },
          "formula_customSetValue_formStore_InputNumber8ub" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9aj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker9a", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9aj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber6od: reaction(
      () => [rootStore.formStore.getValue("Input19p")],
      async ([formStore_Input19p]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber6o", resultData);
          },
          "formula_customSetValue_formStore_InputNumber6od" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
