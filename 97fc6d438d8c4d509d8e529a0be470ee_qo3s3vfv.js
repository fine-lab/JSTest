...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker2ie() {},
  formulacustomSetValueUserReferInput0xk_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker2ie: observable,
  formulacustomSetValueUserReferInput0xk_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker2ie: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("DatePicker2i", resultData);
          },
          "formula_customSetValue_formStore_DatePicker2ie" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_UserReferInput0xk_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("UserReferInput0xk", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput0xk_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
