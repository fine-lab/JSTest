...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker8qh() {},
  formulacustomSetValueDateTimePicker6ia() {},
  formulacustomSetValueInput20zg() {},
  formulacustomSetValueInputNumber2tj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker8qh: observable,
  formulacustomSetValueDateTimePicker6ia: observable,
  formulacustomSetValueInput20zg: observable,
  formulacustomSetValueInputNumber2tj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker8qh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker8q", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8qh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker6ia: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker6i", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6ia" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input20zg: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0mi")],
      async ([formStore_UserReferInput0mi]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0mi.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0mi.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input20z",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input20z", resultData);
          },
          "formula_customSetValue_formStore_Input20zg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2tj: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8q"), rootStore.formStore.getValue("DateTimePicker6i")],
      async ([formStore_DateTimePicker8q, formStore_DateTimePicker6i]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber2t",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8q,DateTimePicker6i,3)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8q,DateTimePicker6i"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2t",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber2t", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2tj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
