...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0ph: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0ph: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0ph: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0ph = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0ph = false;
            }
          },
          "interactionRule_visible_formStore_Summary0ph" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
