...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueReferInput4ri_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueReferInput4ri_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_ReferInput4ri_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput4ri", resultData);
          },
          "formula_customSetValue_formStore_ReferInput4ri_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
