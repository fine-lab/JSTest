...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleToolBar2023() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleToolBar2023: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_ToolBar2023: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleToolBar2023 = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_ToolBar2023" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
