...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput36ok() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput36ok: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input36ok: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0ig")],
      async ([formStore_UserReferInput0ig]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0ig.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0ig.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input36o",
                billnum: "qzxsdd_2023102702",
            ...
            rootStore.formStore.setValue("Input36o", resultData);
          },
          "formula_customSetValue_formStore_Input36ok" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
