...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    const inStockTestSubSql =
      "select distinct id, SY01_purinstockysv2_id,enclosure,fileNo from GT22176AT10.GT22176AT10.SY01_purinstockys_l where dr = 0 and enclosure is not null and material = '" +
      prodCode +
      "' and  batch_no = '" +
      batchNo +
      "'";
