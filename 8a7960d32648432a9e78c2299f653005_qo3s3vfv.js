...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker8wd() {},
  formulacustomSetValueDateTimePicker12cf() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker8wd: observable,
  formulacustomSetValueDateTimePicker12cf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker8wd: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker8w", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8wd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker12cf: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(sysdate,sysdate)",
                formulaFuns: "dateDiff",
                formulaTriggers: "sysdate"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "DateTimePicker12c",
                billnum: "s009",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker12c", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker12cf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
