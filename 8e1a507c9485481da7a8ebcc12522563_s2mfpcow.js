...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode2ok: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode2ok: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode2ok: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode2ok = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode2ok = false;
            }
          },
          "interactionRule_visible_formStore_QRCode2ok" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
