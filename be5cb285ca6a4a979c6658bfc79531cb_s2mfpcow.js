...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleIcons0ob: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleIcons0ob: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Icons0ob: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleIcons0ob = false;
            }
          },
          "interactionRule_visible_formStore_Icons0ob" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
