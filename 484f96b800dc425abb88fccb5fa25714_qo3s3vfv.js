...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueUserReferInput2hg_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueUserReferInput2hg_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_UserReferInput2hg_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("UserReferInput2hg", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput2hg_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
