...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulecustomSetValueInput20xe() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulecustomSetValueInput20xe: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_customSetValue_formStore_Input20xe: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            if (false) {
              ...
              const formulaResult = await countFormula(
                ...
                },
                {
                  ...
                  field: "Input20x",
                  billnum: "yizucheliangshenqingbiao",
          ...
          "interactionRule_customSetValue_formStore_Input20xe" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
