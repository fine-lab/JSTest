...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker8ed() {},
  formulacustomSetValueInputNumber0he() {},
  formulacustomSetValueReferInput2ue_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker8ed: observable,
  formulacustomSetValueInputNumber0he: observable,
  formulacustomSetValueReferInput2ue_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker8ed: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker8e", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8ed" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber0he: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker10l"), rootStore.formStore.getValue("DateTimePicker8e")],
      async ([formStore_DateTimePicker10l, formStore_DateTimePicker8e]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber0h",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker10l,DateTimePicker8e,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker10l,DateTimePicker8e"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber0h",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber0h", resultData);
          },
          "formula_customSetValue_formStore_InputNumber0he" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput2ue_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("ReferInput2ue", resultData);
          },
          "formula_customSetValue_formStore_ReferInput2ue_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
