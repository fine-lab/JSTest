...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueinput26() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueinput26: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_input26: reaction(
      () => [],
      async ([]) => {
        ...
        rootStore.formStore.setValue("new2", resultData);
      },
      {
