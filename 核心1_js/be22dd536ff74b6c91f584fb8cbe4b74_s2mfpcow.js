...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1vb() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1vb: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_TimeLine1vb: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1vb = true;
            } else {
            }
          },
          "interactionRule_visible_unSetStoreAlias_TimeLine1vb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
