...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    let outSql = "select taskDirectiveId,id,batchNumber,detail.id,detail.outCount as outCount,detail.outDate as outDate from AT181E613C1770000A.AT181E613C1770000A.ReservoirOut ";
