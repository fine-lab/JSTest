...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_FixedButton2023: reaction(
      ...
      async ([formStore_new1]) => {
        debounce(
          ...
          "interactionRule_visible_formStore_FixedButton2023 " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
