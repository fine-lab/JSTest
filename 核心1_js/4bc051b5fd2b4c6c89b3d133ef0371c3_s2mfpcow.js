...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleDescription0si: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleDescription0si: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Description0si: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleDescription0si = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleDescription0si = false;
            }
          },
          "interactionRule_visible_formStore_Description0si" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
