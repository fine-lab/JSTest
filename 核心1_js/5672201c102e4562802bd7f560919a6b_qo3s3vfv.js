...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput23ek() {},
  formulacustomSetValueInput27bd() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput23ek: observable,
  formulacustomSetValueInput27bd: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input23ek: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0wi.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0wi.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input23e", resultData);
          },
          "formula_customSetValue_formStore_Input23ek" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input27bd: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker13t")],
      async ([formStore_DateTimePicker13t]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker13t,DateTimePicker9s,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker13t,DateTimePicker9s"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input27b",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input27b", resultData);
          },
          "formula_customSetValue_formStore_Input27bd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
