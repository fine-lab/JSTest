...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput30pd() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput30pd: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input30pd: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker17r"), rootStore.formStore.getValue("DateTimePicker15c")],
      async ([formStore_DateTimePicker17r, formStore_DateTimePicker15c]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "numToStr(dateDiff(DateTimePicker17r,DateTimePicker15c,4))",
                formulaFuns: "numToStr,dateDiff",
                formulaTriggers: "DateTimePicker17r,DateTimePicker15c"
              },
              {
            ...
            rootStore.formStore.setValue("Input30p", resultData);
          },
          "formula_customSetValue_formStore_Input30pd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
