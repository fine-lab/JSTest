...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    var sql = "select * from 	st.othinrecord.OthInRecord where code = '" + request.code + "'";
    ...
    let header = {};
    var apiResponse = openLinker("get", buzUrl + "/yonbip/scm/othinrecord/detail?id=" + res[0].id, "AT19FB439016C80004", JSON.stringify(body));
