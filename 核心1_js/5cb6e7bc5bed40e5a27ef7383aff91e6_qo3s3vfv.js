...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker11xh() {},
  formulacustomSetValueDateTimePicker9xa() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker11xh: observable,
  formulacustomSetValueDateTimePicker9xa: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker11xh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker11x", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker11xh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9xa: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker9x", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9xa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
