...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker0oj() {},
  formulacustomSetValueInput40rj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker0oj: observable,
  formulacustomSetValueInput40rj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker0oj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DatePicker0o", resultData);
          },
          "formula_customSetValue_formStore_DatePicker0oj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input40rj: reaction(
      () => [rootStore.formStore.getValue("UserReferInput2xd")],
      async ([formStore_UserReferInput2xd]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput2xd.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput2xd.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input40r",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input40r", resultData);
          },
          "formula_customSetValue_formStore_Input40rj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
