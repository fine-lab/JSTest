...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_tagpc: reaction(
      ...
      async ([formStore_new1]) => {
        debounce(
          ...
          "interactionRule_visible_formStore_tagpc " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    interactionRule_disabled_formStore_tagpc: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        debounce(
          async () => {
          ...
          "interactionRule_disabled_formStore_tagpc " + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
