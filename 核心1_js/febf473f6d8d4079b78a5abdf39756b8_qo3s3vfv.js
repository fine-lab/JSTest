...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20qf() {},
  formulacustomSetValueDateTimePicker6ag() {},
  formulacustomSetValueDateTimePicker8td() {},
  formulacustomSetValueInputNumber2bj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20qf: observable,
  formulacustomSetValueDateTimePicker6ag: observable,
  formulacustomSetValueDateTimePicker8td: observable,
  formulacustomSetValueInputNumber2bj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20qf: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0me")],
      async ([formStore_UserReferInput0me]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput0me.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0me.mobile"
              },
              {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input20q", resultData);
          },
          "formula_customSetValue_formStore_Input20qf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker6ag: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DateTimePicker6ag" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker8td: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker8t", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8td" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2bj: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8t"), rootStore.formStore.getValue("DateTimePicker6a")],
      async ([formStore_DateTimePicker8t, formStore_DateTimePicker6a]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            const allData = getPageAllData({
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "dateDiff(DateTimePicker8t,DateTimePicker6a,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8t,DateTimePicker6a"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2b",
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("InputNumber2b", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2bj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
