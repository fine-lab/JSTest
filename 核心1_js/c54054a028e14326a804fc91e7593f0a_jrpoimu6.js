...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let shitUrl = sconfig.BASE.URL + "/api/service/esupplier/findCpoResult/1.0.0?suffix_path=/2/1";
    ...
    if (pushObjs.length > 0) {
      let pushBody = { Source_Channel: sconfig.BASE.HT_SOURCE_CHANNEL, data: pushObjs };
