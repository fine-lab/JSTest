...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0jg: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0jg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0jg: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0jg = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0jg = false;
            }
          },
          "interactionRule_visible_formStore_Summary0jg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
