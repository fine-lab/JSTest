...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleBreadcrumb0xd() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleBreadcrumb0xd: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Breadcrumb0xd: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0xd = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0xd = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Breadcrumb0xd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
