...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    //获取首营企业审批单信息
    const get_supper_sql = "select * from GT22176AT10.GT22176AT10.SY01_supcauditv2 where id =" + param.data[0].id;
    ...
    //获取证照信息
    const get_license_sql = "select * from GT22176AT10.GT22176AT10.SY01_gysbgsp_xgzz where SY01_gysbgsp_id =" + param.data[0].id;
    ...
    for (let i = 0; i < lincenseList.length; i++) {
      ...
      let get_license_sub_sql = "select * from GT22176AT10.GT22176AT10.SY01_gysbgsp_xgzz_l where SY01_gysbgsp_xgzz_id =" + lincenseList[i].id;
    ...
    //获取委托书信息
    const get_weituoshu_sql = "select * from GT22176AT10.GT22176AT10.SY01_gysbgsp_sqwts where SY01_gysbgsp_id =" + param.data[0].id;
    ...
    for (let i = 0; i < authList.length; i++) {
      ...
      let get_weituoshu_sub_sql = "select * from GT22176AT10.GT22176AT10.SY01_gysbg_sqwt_l where SY01_gysbgsp_sqwts_id =" + authList[i].id;
    ...
    //获取其他资质及报告
    let get_report_sql = "select * from  GT22176AT10.GT22176AT10.sy01_vendor_change_report where SY01_supcauditv2_id =" + param.data[0].id;
