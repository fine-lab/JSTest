...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let envContenxtUrl = ObjectStore.env().url;
    var data = {
      appcode: appcode,
      gatewayUrl: "",
    ...
    if (envUrl.indexOf(sandbox) == -1) {
      //说明当前环境是生产
      configParams.gatewayUrl = envContenxtUrl + "/iuap-api-gateway";
      configParams.tokenUrl = envContenxtUrl + "/iuap-api-auth";
    } else {
      configParams.gatewayUrl = "https://www.example.com/";
      configParams.tokenUrl = "https://www.example.com/";
    }
    configParams.newUrl = envUrl;
    return { configParams };
  }
}
