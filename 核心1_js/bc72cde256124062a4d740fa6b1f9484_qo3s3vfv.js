...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker8ah() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker8ah: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker8ah: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("undefined", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8ah" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
