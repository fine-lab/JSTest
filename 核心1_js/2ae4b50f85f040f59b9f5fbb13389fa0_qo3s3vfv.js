...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput21uc() {},
  formulacustomSetValueDateTimePicker7ra() {},
  formulacustomSetValueDateTimePicker9id() {},
  formulacustomSetValueInputNumber3zk() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput21uc: observable,
  formulacustomSetValueDateTimePicker7ra: observable,
  formulacustomSetValueDateTimePicker9id: observable,
  formulacustomSetValueInputNumber3zk: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input21uc: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0ye")],
      async ([formStore_UserReferInput0ye]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0ye.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0ye.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input21u", resultData);
          },
          "formula_customSetValue_formStore_Input21uc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker7ra: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker7r", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker7ra" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9id: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker9i", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9id" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber3zk: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9i"), rootStore.formStore.getValue("DateTimePicker7r")],
      async ([formStore_DateTimePicker9i, formStore_DateTimePicker7r]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber3z",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker9i,DateTimePicker7r,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9i,DateTimePicker7r"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber3z",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber3z", resultData);
          },
          "formula_customSetValue_formStore_InputNumber3zk" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
