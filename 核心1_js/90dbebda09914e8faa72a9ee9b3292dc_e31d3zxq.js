  ...
  execute(context, param) {
    ...
    for (let i = 0; i < param.data.length; i++) {
      ...
      if (context.fullname == "GT22176AT10.GT22176AT10.sy01_saleoutstofhv6") {
        let selectCurrentYsr = "select id,recheckMan from GT22176AT10.GT22176AT10.sy01_saleoutstofhv6 where id = '" + param.data[0].id + "'";
        let CurrentYsr = ObjectStore.queryByYonQL(selectCurrentYsr, "sy01")[0].recheckMan;
        if (CurrentYsr != undefined && CurrentYsr != null) {
          return;
        }
      ...
      if (context.fullname == "GT22176AT10.GT22176AT10.SY01_purinstockysv2") {
        let selectCurrentYsr = "select id,inspecter from GT22176AT10.GT22176AT10.SY01_purinstockysv2 where id = '" + param.data[0].id + "'";
        let CurrentYsr = ObjectStore.queryByYonQL(selectCurrentYsr, "sy01")[0].inspecter;
        if (CurrentYsr != undefined && CurrentYsr != null) {
          return;
        }
