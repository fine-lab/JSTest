...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker5ah() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker5ah: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker5ah: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DatePicker5a", resultData);
          },
          "formula_customSetValue_formStore_DatePicker5ah" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
