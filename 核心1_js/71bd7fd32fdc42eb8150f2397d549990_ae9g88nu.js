run = function (event) {
  ...
  let switchDisplayFields = function (gridModel, number) {
    ...
    let fields = ["authProduct_name", "authProductType_catagoryname", "authDosageForm_dosagaFormName", "authSku_name", "item92sh", "authProductCode", "authFeatures"];
    ...
    switch (number) {
      case 1:
        gridModel.setColumnState("authProduct", "visible", true);
        gridModel.setColumnState("authProduct", "bCanModify", true);
      ...
      case 2:
        ...
        break;
      case 3:
        gridModel.setColumnState("authDosageForm", "visible", true);
        gridModel.setColumnState("authDosageForm", "bCanModify", true);
