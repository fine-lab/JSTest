...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20ne() {},
  formulacustomSetValueInputNumber2rg() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20ne: observable,
  formulacustomSetValueInputNumber2rg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20ne: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0ne")],
      async ([formStore_UserReferInput0ne]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("Input20n", resultData);
          },
          "formula_customSetValue_formStore_Input20ne" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2rg: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8o"), rootStore.formStore.getValue("DateTimePicker6c")],
      async ([formStore_DateTimePicker8o, formStore_DateTimePicker6c]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8o,DateTimePicker6c,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8o,DateTimePicker6c"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2r",
          ...
          "formula_customSetValue_formStore_InputNumber2rg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
