...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let sql = "select material,isSku,materialType,approvalValidityDate from GT22176AT10.GT22176AT10.SY01_material_file where org_id  = " + orgId + " and material = " + productId;
