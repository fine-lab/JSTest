...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode2nh: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode2nh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode2nh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode2nh = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode2nh = false;
            }
          },
          "interactionRule_visible_formStore_QRCode2nh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
