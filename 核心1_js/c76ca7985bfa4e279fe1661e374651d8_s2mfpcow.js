...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleBreadcrumb0pc: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleBreadcrumb0pc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Breadcrumb0pc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0pc = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleBreadcrumb0pc = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Breadcrumb0pc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
