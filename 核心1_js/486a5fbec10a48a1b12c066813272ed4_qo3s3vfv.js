...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20kj() {},
  formulacustomSetValueDateTimePicker9zh() {},
  formulacustomSetValueDateTimePicker11fd() {},
  formulacustomSetValueInputNumber5ck() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20kj: observable,
  formulacustomSetValueDateTimePicker9zh: observable,
  formulacustomSetValueDateTimePicker11fd: observable,
  formulacustomSetValueInputNumber5ck: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20kj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0ne.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0ne.mobile"
              },
              {
          ...
          "formula_customSetValue_formStore_Input20kj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker9zh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker9z", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9zh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker11fd: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker11f", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker11fd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber5ck: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker11f")],
      async ([formStore_DateTimePicker11f]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber5c",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker11f,DateTimePicker6c,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker11f,DateTimePicker6c"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber5c",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber5c", resultData);
          },
          "formula_customSetValue_formStore_InputNumber5ck" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
