...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker10ud() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker10ud: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker10ud: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: '"mainJobList.staff_id.mainJobList.staff_id.mainJobList.enddate"',
                formulaFuns: "",
                formulaTriggers: ""
              },
              {
          ...
          "formula_customSetValue_formStore_DateTimePicker10ud" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
