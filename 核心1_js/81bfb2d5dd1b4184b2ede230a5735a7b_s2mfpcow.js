...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleHeader1vi: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleHeader1vi: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Header1vi: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleHeader1vi = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleHeader1vi = true;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Header1vi" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
