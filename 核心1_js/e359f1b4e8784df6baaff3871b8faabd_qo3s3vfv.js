...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueinputnumber42() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueinputnumber42: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_inputnumber42: reaction(
      () => [rootStore.formStore.getValue("shuliangmu"), rootStore.formStore.getValue("danjiayuanmu")],
      async ([formStore_shuliangmu, formStore_danjiayuanmu]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "shuliangmu*danjiayuanmu",
                formulaFuns: "",
                formulaTriggers: "shuliangmu,danjiayuanmu"
              },
              {
          ...
          "formula_customSetValue_formStore_inputnumber42" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
