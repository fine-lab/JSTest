...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode0gb: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode0gb: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode0gb: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode0gb = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode0gb = false;
            }
          },
          "interactionRule_visible_formStore_QRCode0gb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
