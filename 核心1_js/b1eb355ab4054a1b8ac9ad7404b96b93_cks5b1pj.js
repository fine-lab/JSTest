        ...
        subjectCodes.forEach((item) => {
          ...
          if (datas != null) {
            datas.forEach((element) => {
              // 对接口返回的浮点数0.0做替换
              element.localdebit1 = element.localdebit1 == "" ? 0 : parseFloat(element.localdebit1);
              element.localdebit2 = element.localdebit2 == "" ? 0 : parseFloat(element.localdebit2);
              element.localdebit3 = element.localdebit3 == "" ? 0 : parseFloat(element.localdebit3);
              element.localdebit4 = element.localdebit4 == "" ? 0 : parseFloat(element.localdebit4);
              element.localcredebit1 = element.localcredebit1 == "" ? 0 : parseFloat(element.localcredebit1);
              element.localcredebit2 = element.localcredebit2 == "" ? 0 : parseFloat(element.localcredebit2);
              element.localcredebit3 = element.localcredebit3 == "" ? 0 : parseFloat(element.localcredebit3);
              element.localcredebit4 = element.localcredebit4 == "" ? 0 : parseFloat(element.localcredebit4);
              //获取入参科目信息
          ...
          if (responseSubject != null) {
            subjectNameRes = responseSubject.accsubject_name;
          }
          response[item] = {
            subjectCode: item,
            subjectName: subjectNameRes,
