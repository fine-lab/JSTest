...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let yonql = "select customerbillno from GT22176AT10.GT22176AT10.SY01_fcuscauditv2 where dr = 0 and id = '" + param.data[0].id + "'";
    let auditRes = ObjectStore.queryByYonQL(yonql, "sy01")[0];
    ...
    // 拼装请求报文
    var obj = { tenantId: tenantid, logId: "yourIdHere", time: timestampStr, uuid: sign, productId: auditRes.customerbillno, userId: ObjectStore.user().id };
