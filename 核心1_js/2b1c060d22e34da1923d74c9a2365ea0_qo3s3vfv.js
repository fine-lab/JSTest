...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20xa() {},
  formulacustomSetValueDateTimePicker6id() {},
  formulacustomSetValueInputNumber2ii() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20xa: observable,
  formulacustomSetValueDateTimePicker6id: observable,
  formulacustomSetValueInputNumber2ii: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20xa: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0oj")],
      async ([formStore_UserReferInput0oj]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0oj.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0oj.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input20x", resultData);
          },
          "formula_customSetValue_formStore_Input20xa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker6id: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_DateTimePicker6id" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2ii: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8u"), rootStore.formStore.getValue("DateTimePicker6i")],
      async ([formStore_DateTimePicker8u, formStore_DateTimePicker6i]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber2i",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8u,DateTimePicker6i,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8u,DateTimePicker6i"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2i",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber2i", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2ii" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
