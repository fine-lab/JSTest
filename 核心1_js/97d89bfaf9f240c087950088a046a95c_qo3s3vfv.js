...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput21yf() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput21yf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input21yf: reaction(
      () => [rootStore.formStore.getValue("UserReferInput1sd")],
      async ([formStore_UserReferInput1sd]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput1sd.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput1sd.mobile"
              },
              {
            ...
            rootStore.formStore.setValue("Input21y", resultData);
          },
          "formula_customSetValue_formStore_Input21yf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
