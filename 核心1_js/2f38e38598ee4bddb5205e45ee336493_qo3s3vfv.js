...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber8nh() {},
  formulacustomSetValueInputNumber12uf() {},
  formulacustomSetValueInputNumber16og() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber8nh: observable,
  formulacustomSetValueInputNumber12uf: observable,
  formulacustomSetValueInputNumber16og: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber8nh: reaction(
      () => [rootStore.formStore.getValue("InputNumber6s"), rootStore.formStore.getValue("InputNumber4t")],
      async ([formStore_InputNumber6s, formStore_InputNumber4t]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber8n",
              storeForm: "",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber6s-InputNumber4t",
                formulaFuns: "",
                formulaTriggers: "InputNumber6s,InputNumber4t"
              },
              {
            ...
            rootStore.formStore.setValue("InputNumber8n", resultData);
          },
          "formula_customSetValue_formStore_InputNumber8nh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber12uf: reaction(
      () => [rootStore.formStore.getValue("InputNumber12u"), rootStore.formStore.getValue("InputNumber8n")],
      async ([formStore_InputNumber12u, formStore_InputNumber8n]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber12u",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber12u*InputNumber8n",
                formulaFuns: "",
                formulaTriggers: "InputNumber12u,InputNumber8n"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber12u",
                billnum: "pdxhcd",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber12u", resultData);
          },
          "formula_customSetValue_formStore_InputNumber12uf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber16og: reaction(
      () => [rootStore.formStore.getValue("InputNumber14c"), rootStore.formStore.getValue("InputNumber12u")],
      async ([formStore_InputNumber14c, formStore_InputNumber12u]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber16o",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber14c+InputNumber12u",
                formulaFuns: "",
                formulaTriggers: "InputNumber14c,InputNumber12u"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber16o",
                billnum: "pdxhcd",
                domainKey: "yourKeyHere",
                allData: allData || {}
              }
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber16o", resultData);
          },
          "formula_customSetValue_formStore_InputNumber16og" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
