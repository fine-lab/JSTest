...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput20qh() {},
  formulacustomSetValueInputNumber5ab() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput20qh: observable,
  formulacustomSetValueInputNumber5ab: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input20qh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
          ...
          "formula_customSetValue_formStore_Input20qh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber5ab: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber5a", resultData);
          },
          "formula_customSetValue_formStore_InputNumber5ab" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
