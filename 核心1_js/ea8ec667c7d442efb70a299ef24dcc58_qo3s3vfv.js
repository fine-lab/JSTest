...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker6ad() {},
  formulacustomSetValueDateTimePicker8fg() {},
  formulacustomSetValueInput20kd() {},
  formulacustomSetValueInputNumber2rj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker6ad: observable,
  formulacustomSetValueDateTimePicker8fg: observable,
  formulacustomSetValueInput20kd: observable,
  formulacustomSetValueInputNumber2rj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker6ad: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker6a", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6ad" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker8fg: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker8f", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker8fg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input20kd: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0nf")],
      async ([formStore_UserReferInput0nf]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0nf.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0nf.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input20k",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input20k", resultData);
          },
          "formula_customSetValue_formStore_Input20kd" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber2rj: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker8f"), rootStore.formStore.getValue("DateTimePicker6a")],
      async ([formStore_DateTimePicker8f, formStore_DateTimePicker6a]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber2r",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker8f,DateTimePicker6a,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker8f,DateTimePicker6a"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber2r",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber2r", resultData);
          },
          "formula_customSetValue_formStore_InputNumber2rj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
