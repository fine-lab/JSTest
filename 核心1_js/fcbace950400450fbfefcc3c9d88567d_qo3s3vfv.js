...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker14eg() {},
  formulacustomSetValueDateTimePicker16jj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker14eg: observable,
  formulacustomSetValueDateTimePicker16jj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker14eg: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker14e", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker14eg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker16jj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker16j", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker16jj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
