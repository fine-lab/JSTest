...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput29ae() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput29ae: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input29ae: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input29a", resultData);
          },
          "formula_customSetValue_formStore_Input29ae" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
