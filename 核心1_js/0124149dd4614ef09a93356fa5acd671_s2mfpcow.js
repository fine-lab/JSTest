...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTimeLine1fc() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTimeLine1fc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_TimeLine1fc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTimeLine1fc = true;
            } else {
            }
          },
          "interactionRule_visible_unSetStoreAlias_TimeLine1fc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
