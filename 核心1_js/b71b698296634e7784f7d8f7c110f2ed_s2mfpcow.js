...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleText0yb: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleText0yb: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Text0yb: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleText0yb = false;
            }
          },
          "interactionRule_visible_formStore_Text0yb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
