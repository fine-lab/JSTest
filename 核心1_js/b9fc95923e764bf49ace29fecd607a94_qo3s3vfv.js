...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker13rh() {},
  formulacustomSetValueDateTimePicker15jj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker13rh: observable,
  formulacustomSetValueDateTimePicker15jj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker13rh: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("DateTimePicker13r", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker13rh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker15jj: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("DateTimePicker15j", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker15jj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
