viewModel.on("customInit", function (data) {
  ...
  viewModel.get("button56xd") &&
    viewModel.get("button56xd").on("click", function (data) {
      ...
      let param = { filterSchemeId: viewModel.get("curing_filter_scheme_name").getValue(), warehouseId: viewModel.get("warehouse").getValue(), orgId: viewModel.get("finOrg").getValue() };
