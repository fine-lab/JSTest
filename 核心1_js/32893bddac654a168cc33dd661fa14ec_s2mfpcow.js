...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleIcons2023() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleIcons2023: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_Icons2023: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleIcons2023 = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_Icons2023" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
