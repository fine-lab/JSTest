...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    //购进退出复核
    let ySql =
      "select sourcechild_id,id,batchID,batch_no,qualifie_qty,unqualifie_qty,noqualifiedstate,noqualifiedstateName,qualifiedstate,qualifiedstateName,noQualifedResult,manufact_date,valid_until,position from GT22176AT10.GT22176AT10.SY01_gjtcfh_l" +
      " where sourcechild_id = '" +
      purChildId +
