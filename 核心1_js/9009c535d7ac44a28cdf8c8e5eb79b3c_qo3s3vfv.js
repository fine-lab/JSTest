...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueUserReferInput5sa_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueUserReferInput5sa_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_UserReferInput5sa_refer: reaction(
      () => [rootStore.formStore.getValue("UserReferInput3zj")],
      async ([formStore_UserReferInput3zj]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            let result = await countFormula(
              {
                hasFormula: "",
                formula: "UserReferInput3zj.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput3zj.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "UserReferInput5sa",
                billnum: "clgl",
            ...
            // 公式结束loading
            rootStore.formStore.setValue("UserReferInput5sa", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput5sa_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
