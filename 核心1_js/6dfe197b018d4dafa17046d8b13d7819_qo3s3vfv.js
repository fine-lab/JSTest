...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInputNumber7gf() {},
  formulacustomSetValueInputNumber9fg() {},
  formulacustomSetValueInput39mc() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInputNumber7gf: observable,
  formulacustomSetValueInputNumber9fg: observable,
  formulacustomSetValueInput39mc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_InputNumber7gf: reaction(
      () => [rootStore.formStore.getValue("InputNumber2g"), rootStore.formStore.getValue("InputNumber5h")],
      async ([formStore_InputNumber2g, formStore_InputNumber5h]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber7g",
              storeForm: "",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber2g-InputNumber5h",
                formulaFuns: "",
                formulaTriggers: "InputNumber2g,InputNumber5h"
              },
              {
            ...
            rootStore.formStore.setValue("InputNumber7g", resultData);
          },
          "formula_customSetValue_formStore_InputNumber7gf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_InputNumber9fg: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker9l"), rootStore.formStore.getValue("DateTimePicker7a")],
      async ([formStore_DateTimePicker9l, formStore_DateTimePicker7a]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "FormStore",
              storeField: "InputNumber9f",
              storeForm: "",
              dataSource: "mainEntity"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker9l,DateTimePicker7a,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker9l,DateTimePicker7a"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "InputNumber9f",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("InputNumber9f", resultData);
          },
          "formula_customSetValue_formStore_InputNumber9fg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input39mc: reaction(
      () => [
        rootStore.formStore.getValue("InputNumber11i"),
        rootStore.formStore.getValue("InputNumber7g"),
        rootStore.formStore.getValue("InputNumber13t"),
        rootStore.formStore.getValue("InputNumber9f")
      ],
      async ([formStore_InputNumber11i, formStore_InputNumber7g, formStore_InputNumber13t, formStore_InputNumber9f]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "InputNumber11i*InputNumber7g+InputNumber13t*InputNumber9f",
                formulaFuns: "",
                formulaTriggers: "InputNumber11i,InputNumber7g,InputNumber13t,InputNumber9f"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input39m",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input39m", resultData);
          },
          "formula_customSetValue_formStore_Input39mc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
