...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode0xh: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode0xh: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_QRCode0xh: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode0xh = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode0xh = false;
            }
          },
          "interactionRule_visible_formStore_QRCode0xh" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
