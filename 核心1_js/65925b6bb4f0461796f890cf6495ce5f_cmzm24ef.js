...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleinput34() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleinput34: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_input34: reaction(
      () => [rootStore.formStore.getValue("InputNumber2zd")],
      async ([formStore_InputNumber2zd]) => {
        debounce(
          async () => {
            if (
              expressionParsing({
                leftValue: formStore_InputNumber2zd,
                operational: "eq",
                rightValue: "1",
                extLeftValue: {
                  bizType: "number"
              ...
              rootStore.computedAttrStore.interactionRulevisibleinput34 = false;
            }
          },
          "interactionRule_visible_formStore_input34" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
