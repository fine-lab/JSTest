...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    if (param.data[0]._fromApi) {
      ...
      //物料编码和名称赋值
      //产品编码
      let productId_code = param.data[0].productId_name;
      //实物物料id
      let phymaterial_id_code = param.data[0].phymaterial_id_name;
      ...
      throw new Error(" line 41 " + JSON.stringify(param));
    ...
    [光标位置]
      ...
      if (param.data[0].org_id == null || param.data[0].org_id == "") {
        param.data[0].set("org_id", "1490021994727473155");
      }
