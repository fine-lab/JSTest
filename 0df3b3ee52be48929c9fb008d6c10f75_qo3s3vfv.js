...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDatePicker2hb() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDatePicker2hb: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DatePicker2hb: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("DatePicker2h", resultData);
          },
          "formula_customSetValue_formStore_DatePicker2hb" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
