...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    if (context.fullname == "GT22176AT10.GT22176AT10.SY01_fccusauditv4") {
      let sql = "select id,org_id,customerbillno,is_sku from GT22176AT10.GT22176AT10.SY01_fccusauditv4 where id = '" + param.data[0].id + "'";
      ...
      let isHaveGSPSql = "select id from GT22176AT10.GT22176AT10.SY01_material_file where org_id = '" + orgId + "' and material = '" + materialId + "' and isSku = " + type;
