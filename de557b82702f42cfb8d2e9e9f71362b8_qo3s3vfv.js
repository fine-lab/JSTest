...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueDateTimePicker9oa() {},
  formulacustomSetValueInput27jj() {},
  formulacustomSetValueInput21jj() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueDateTimePicker9oa: observable,
  formulacustomSetValueInput27jj: observable,
  formulacustomSetValueInput21jj: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_DateTimePicker9oa: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: 'dateFormat(sysdate(),"yyyy-MM-dd HH:mm:ss")',
                formulaFuns: "dateFormat,sysdate",
                formulaTriggers: ""
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "DateTimePicker9o",
                billnum: "clsysqd20231118",
            ...
            rootStore.formStore.setValue("DateTimePicker9o", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker9oa" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input27jj: reaction(
      () => [rootStore.formStore.getValue("DateTimePicker13u"), rootStore.formStore.getValue("DateTimePicker11e")],
      async ([formStore_DateTimePicker13u, formStore_DateTimePicker11e]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "dateDiff(DateTimePicker13u,DateTimePicker11e,4)",
                formulaFuns: "dateDiff",
                formulaTriggers: "DateTimePicker13u,DateTimePicker11e"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input27j",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input27j", resultData);
          },
          "formula_customSetValue_formStore_Input27jj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Input21jj: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0sb")],
      async ([formStore_UserReferInput0sb]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0sb.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0sb.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input21j",
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Input21j", resultData);
          },
          "formula_customSetValue_formStore_Input21jj" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
