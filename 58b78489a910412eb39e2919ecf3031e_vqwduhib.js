...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let f = "";
    f += "product.model";
    f += ",product.modelDescription";
    f += ",productsku.modelDescription";
    f += ",arrivalOrdersCharacteristics";
    f += ",product.productOfflineRetail.isExpiryDateManage";
    let sql = "select " + f + " from pu.arrivalorder.ArrivalOrders where mainid ='youridHere'";
    let staffinfo = ObjectStore.queryByYonQL(sql, "upu");
