...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleQRCode0fe() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleQRCode0fe: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_unSetStoreAlias_QRCode0fe: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleQRCode0fe = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleQRCode0fe = false;
            }
          },
          "interactionRule_visible_unSetStoreAlias_QRCode0fe" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
