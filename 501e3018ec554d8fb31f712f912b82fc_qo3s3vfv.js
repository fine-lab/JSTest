...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueInput23mg() {},
  formulacustomSetValueDateTimePicker6sg() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueInput23mg: observable,
  formulacustomSetValueDateTimePicker6sg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Input23mg: reaction(
      () => [rootStore.formStore.getValue("Input23m")],
      async ([formStore_Input23m]) => {
        debounce(
          async () => {
            // 获取当前页面所有数据
            ...
            // 公式结束loading
            rootStore.formStore.setValue("Input23m", resultData);
          },
          "formula_customSetValue_formStore_Input23mg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DateTimePicker6sg: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DateTimePicker6s", resultData);
          },
          "formula_customSetValue_formStore_DateTimePicker6sg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
