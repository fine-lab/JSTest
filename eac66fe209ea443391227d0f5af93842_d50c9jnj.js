...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    sql +=
      "dd.orderedQuantity orderedQuantity,dd.po_confirm_time po_confirm_time,dd.po_activation_time po_activation_time,dd.rsd rsd,dd.rsd2 rsd2,dd.dcNameCn dcNameCn,dd.itemCode itemCode,dd.oriRequestedQuantity oriRequestedQuantity,dd.shippingMethod shippingMethod,dd.cabinetNodeCode cabinetNodeCode,dd.quantitiy quantitiy ";
    ...
    for (let i = 0; i < res.length; i++) {
      ...
      htData.FOB = "";
      htData.FOB_ADDRESS = "";
      htData.PO_CONFIRM_DATE = item.po_confirm_time; // 供应商反推
      htData.PO_ACTIVE_DATE = item.po_activation_time; // 供应商反推
