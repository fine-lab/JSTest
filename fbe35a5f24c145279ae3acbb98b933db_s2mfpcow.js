...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleSummary0sg: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleSummary0sg: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Summary0sg: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleSummary0sg = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleSummary0sg = false;
            }
          },
          "interactionRule_visible_formStore_Summary0sg" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
