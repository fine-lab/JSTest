...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleText0dc: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleText0dc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Text0dc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleText0dc = false;
            }
          },
          "interactionRule_visible_formStore_Text0dc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
