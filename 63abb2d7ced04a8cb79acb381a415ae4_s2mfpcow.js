...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTag0mf: null,
  interactionRuledisabledTag0mf: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTag0mf: observable,
  interactionRuledisabledTag0mf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Tag0mf: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTag0mf = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleTag0mf = true;
            }
          },
          "interactionRule_visible_formStore_Tag0mf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    interactionRule_disabled_formStore_Tag0mf: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRuledisabledTag0mf = true;
            } else {
              rootStore.computedAttrStore.interactionRuledisabledTag0mf = false;
            }
          },
          "interactionRule_disabled_formStore_Tag0mf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
