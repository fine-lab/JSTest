...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let selectReviewQl =
      "select id,sourcechild_id,batch_no,manufact_date,valid_until,qualifie_qty,quaInState,quaInStateName,unqualifie_qty,unquaDealType,unQuaNeedInQty,unQuaInState,unQuaInStateName,uncertain_qty,position from " +
