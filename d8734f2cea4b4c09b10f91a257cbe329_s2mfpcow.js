...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleTag0pc: null,
  interactionRuledisabledTag0pc: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleTag0pc: observable,
  interactionRuledisabledTag0pc: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Tag0pc: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleTag0pc = false;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleTag0pc = true;
            }
          },
          "interactionRule_visible_formStore_Tag0pc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    interactionRule_disabled_formStore_Tag0pc: reaction(
      () => [rootStore.formStore.getValue("new1")],
      async ([formStore_new1]) => {
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRuledisabledTag0pc = true;
            } else {
              rootStore.computedAttrStore.interactionRuledisabledTag0pc = false;
            }
          },
          "interactionRule_disabled_formStore_Tag0pc" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
