...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleBreadcrumbdaily() {}
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleBreadcrumbdaily: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Breadcrumbdaily: reaction(
      ...
      async ([formStore_new1]) => {
        if (
          ...
          rootStore.computedAttrStore.interactionRulevisibleBreadcrumbdaily = false;
        } else {
          rootStore.computedAttrStore.interactionRulevisibleBreadcrumbdaily = true;
        }
      },
      {
