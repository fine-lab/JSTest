...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var qjSql = `select * from AT19426EC817080004.AT19426EC817080004.ZZD where id = ` + billId;
    console.log(qjSql);
    ...
    var yuangongsuoshubumen = QJDRes[0].yewuguishubumen;
    //查询审批规则子表，获取符合条件的审核信息
    var sql = `select * from AT19426EC817080004.AT19426EC817080004.ZB1 where yewuguishubumen = "` + yuangongsuoshubumen + `" and yewuleixing = "转正" `;
    ...
    yjsp = res.yijishenpi;
    yjjc = res.yijijuece;
    EJSP = res.ZB1_erjishenpiduorenqiangzhanshenpiList.map((obj) => obj.erjishenpiduorenqiangzhanshenpi);
