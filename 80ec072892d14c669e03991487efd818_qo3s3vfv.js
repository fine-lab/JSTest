...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueEnumerate19je() {},
  formulacustomSetValueEnumerate17kf() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueEnumerate19je: observable,
  formulacustomSetValueEnumerate17kf: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_Enumerate19je: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            rootStore.formStore.setValue("Enumerate19j", resultData);
          },
          "formula_customSetValue_formStore_Enumerate19je" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_Enumerate17kf: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            //对公式结果进行处理
            const resultData = formulaResult.resultData;
            rootStore.formStore.setValue("Enumerate17k", resultData);
          },
          "formula_customSetValue_formStore_Enumerate17kf" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
