...
const computedAttrStore = {
  // 扩展get 方法
  interactionRulevisibleDescription0ec: null
};
// 方法改成计算方法
const computedAttr = {
  interactionRulevisibleDescription0ec: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    interactionRule_visible_formStore_Description0ec: reaction(
        ...
        debounce(
          async () => {
            if (
              ...
              rootStore.computedAttrStore.interactionRulevisibleDescription0ec = true;
            } else {
              rootStore.computedAttrStore.interactionRulevisibleDescription0ec = false;
            }
          },
          "interactionRule_visible_formStore_Description0ec" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
