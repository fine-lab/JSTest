...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueReferInput2gj_refer() {},
  formulacustomSetValueDatePicker0le() {},
  formulacustomSetValueReferInput3me_refer() {},
  formulacustomSetValueUserReferInput10zd_refer() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueReferInput2gj_refer: observable,
  formulacustomSetValueDatePicker0le: observable,
  formulacustomSetValueReferInput3me_refer: observable,
  formulacustomSetValueUserReferInput10zd_refer: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_formStore_ReferInput2gj_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput2gj", resultData);
          },
          "formula_customSetValue_formStore_ReferInput2gj_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_DatePicker0le: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("DatePicker0l", resultData);
          },
          "formula_customSetValue_formStore_DatePicker0le" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_ReferInput3me_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("ReferInput3me", resultData);
          },
          "formula_customSetValue_formStore_ReferInput3me_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_UserReferInput10zd_refer: reaction(
      () => [],
      async ([]) => {
        debounce(
          async () => {
            ...
            const resultData = result.resultData;
            // 公式结束loading
            rootStore.formStore.setValue("UserReferInput10zd", resultData);
          },
          "formula_customSetValue_formStore_UserReferInput10zd_refer" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
