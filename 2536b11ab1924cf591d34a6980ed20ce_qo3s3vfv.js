...
const computedAttrStore = {
  // 扩展get 方法
  formulacustomSetValueinputnumber110() {},
  formulacustomSetValueinput11() {}
};
// 方法改成计算方法
const computedAttr = {
  formulacustomSetValueinputnumber110: observable,
  formulacustomSetValueinput11: observable
};
// 设置监听
...
rootStore.eventBus.on(rootStore, "load", function () {
  rootStore.reactions.computedAttr = {
    formula_customSetValue_qzxsdd_2023102701_child1ListStore_subFormStore_inputnumber110: reaction(
      () => [rootStore.qzxsdd_2023102701_child1ListStore_subFormStore.getValue("InputNumber6f"), rootStore.qzxsdd_2023102701_child1ListStore_subFormStore.getValue("InputNumber1f")],
      async ([qzxsdd_2023102701_child1ListStore_subFormStore_InputNumber6f, qzxsdd_2023102701_child1ListStore_subFormStore_InputNumber1f]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
              storeControlType: "TableFormStore",
              storeField: "InputNumber5k",
              storeForm: "qzxsdd_2023102701_child1ListStore_subFormStore",
              dataSource: "qzxsdd_2023102701_child1List"
            });
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "qzxsdd_2023102701_child1List.InputNumber6f*qzxsdd_2023102701_child1List.InputNumber1f",
                formulaFuns: "",
                formulaTriggers: "qzxsdd_2023102701_child1List.InputNumber6f,qzxsdd_2023102701_child1List.InputNumber1f"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "qzxsdd_2023102701_child1List.InputNumber5k",
                billnum: "qzxsdd_2023102701MobileArchive",
            ...
            rootStore.qzxsdd_2023102701_child1ListStore_subFormStore.setValue("InputNumber5k", resultData);
          },
          "formula_customSetValue_qzxsdd_2023102701_child1ListStore_subFormStore_inputnumber110" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
    ...
    formula_customSetValue_formStore_input11: reaction(
      () => [rootStore.formStore.getValue("UserReferInput0ok")],
      async ([formStore_UserReferInput0ok]) => {
        debounce(
          async () => {
            const allData = getAllDataByCardStore({
              cardStoreAlias: "cardStore",
            ...
            const formulaResult = await countFormula(
              {
                hasFormula: "true",
                formula: "UserReferInput0ok.mobile",
                formulaFuns: "",
                formulaTriggers: "UserReferInput0ok.mobile"
              },
              {
                mainDataSourceAlias: "mainEntity",
                field: "Input34m",
          ...
          "formula_customSetValue_formStore_input11" + "_" + tableStoreRowIndex + "_" + subTableStoreRowIndex,
          300
        )();
      },
      {
