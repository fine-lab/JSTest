...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    var sql = "select * from 	st.storeout.StoreOut where code = '" + request.code + "'";
    ...
    let header = {};
    var apiResponse = openLinker("get", buzUrl + "/yonbip/scm/storeout/detail?id=" + res[0].id, "AT19FB439016C80004", JSON.stringify(body));
